...
const LOCALES = {
  en: {
    ...
    model_error_label_not_found: 'Model not found',
    model_error_label_auth: 'API Key error',
    model_error_label_generic: 'Model config error',
    model_error_hint_prefix: '',
    model_error_fix_btn: 'Go to Settings',
    model_error_dismiss_btn: 'Dismiss',
    ...
    cmd_skills: 'List available Cosmius Hermes skills',
  ...
  status_agent_running:'Agent running',
    ...
    status_hermes_home: 'Cosmius Hermes home',
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    session_exit_select_mode: 'Exit select mode',
    session_projects_all: 'All',
    project_btn_new_title: 'New project',
    sessions_other_profiles_link: (n) => `Show ${n} from other profiles`,
    sessions_active_profile_only_link: 'Show active profile only',
    sessions_archived_hide: 'Hide archived',
    sessions_archived_show: (n) => `Show ${n} archived`,
    sessions_empty_in_project: 'No sessions in this project yet.',
    session_group_pinned: '\u2605 Pinned',
    session_title_system_placeholder: 'Session',
    session_actions_aria: 'Conversation actions',
    session_delete_confirm_short: 'Delete this conversation?',
    conversation_deleted_toast: 'Conversation deleted',
    topbar_subtitle_new_chat: 'Start a new conversation',
    session_switch_wait_turn: 'Finish the current turn before switching sessions.',
    project_picker_none: 'No project',
    session_toast_removed_from_project: 'Removed from project',
    session_toast_moved_to_project: (name) => `Moved to ${name}`,
    session_toast_archive_failed: 'Archive failed: ',
    session_toast_delete_failed: 'Delete failed: ',
    session_toast_move_failed: 'Move failed: ',
    session_duplicate_title_suffix: ' (copy)',
    session_source_weixin: 'Weixin',
    gateway_sync_unavailable: 'Gateway sync unavailable \u2014 falling back to periodic refresh.',
    queued_messages_restored_multi: (n) => `${n} queued messages restored (showing first)`,
    queued_message_restored: 'Queued message restored',
    queued_review_send_hint: ' \u2014 review and send when ready',
    session_rename_failed_prefix: 'Rename failed: ',
    project_name_placeholder_short: 'Project name',
    tag_filter_by_title: (tag) => `Click to filter by ${tag}`,
    project_picker_create_new: '+ New project',
    project_created_and_moved: (name) => `Created "${name}" and moved session`,
    project_created_toast: 'Project created',
    project_renamed_toast: 'Project renamed',
    project_color_updated: 'Color updated',
    project_delete_confirm_message: (name) =>
      `Delete project "${name}"? Sessions will be unassigned but not deleted.`,
    project_deleted_toast: 'Project deleted',
    session_delete_failed_status: (msg) => `Delete failed: ${msg}`,
    // settings panel
    ...
    settings_section_preferences_meta: 'Defaults and UI behavior for Cosmius Hermes.',
    ...
    settings_factory_reset_title: 'Reset initial setup',
    settings_factory_reset_desc: 'Clears provider/model setup, quick-setup API keys, and the Web UI password, then reopens the first-run wizard. Chat sessions are kept.',
    settings_factory_reset_btn: 'Reset setup…',
    settings_factory_reset_prompt: 'Clear provider/model setup, quick-setup API keys, and the Web UI password, then reopen the first-run wizard? Chat sessions will be kept.',
    settings_factory_reset_password_prompt: 'Access password is enabled. Enter your password to authorize the wipe:',
    settings_factory_reset_done: 'Initial setup reset.',
    settings_factory_reset_failed: 'Reset setup failed: ',
    ...
    platforms_main_sidebar_hint:
      'Use the sidebar list to pick a platform. The configuration drawer opens over the list; save when done.',
    connect_app_title: 'Connect App',
    connect_app_subtitle: 'Configure and enable messaging integrations.',
    connect_app_search_placeholder: 'Search platforms…',
    connect_app_filter_all: 'All',
    connect_app_group_top_picks: 'Top picks',
    connect_app_group_international_im: 'International IM',
    connect_app_group_china_workplace_wechat: 'China workplace & WeChat',
    connect_app_group_open_interfaces: 'Open interfaces',
    connect_app_group_traditional_channels: 'Traditional channels',
    connect_app_group_others: 'Others',
    connect_app_status_not_configured: 'Not configured',
    connect_app_status_configured: 'Configured (not connected)',
    connect_app_status_connected: 'Connected',
    connect_app_status_error: 'Connection error',
    connect_app_configure: 'Configure',
    connect_app_save_enable: 'Save & enable',
    connect_app_test_connection: 'Test connection',
    connect_app_disable: 'Disable',
    connect_app_required: 'Required',
    connect_app_optional: 'Optional',
    connect_app_advanced: 'Advanced',
    connect_app_saved_enabled: 'Saved and enabled.',
    connect_app_test_success: 'Connection test succeeded.',
    connect_app_test_failed_kept: 'Connection test failed; configuration was kept.',
    connect_app_disabled: 'Disabled.',
    connect_app_weixin_qr_intro:
      'Personal WeChat uses Tencent iLink. Generate a QR code, scan with WeChat, then save to write credentials to config.',
    connect_app_weixin_get_qr: 'Get QR code',
    connect_app_weixin_open_link: 'Open scan link',
    connect_app_weixin_requesting: 'Requesting QR…',
    connect_app_weixin_status_wait: 'Waiting for scan…',
    connect_app_weixin_status_scaned: 'Scanned — confirm on your phone…',
    connect_app_weixin_status_redirect: 'Switching login region…',
    connect_app_weixin_status_expired: 'QR expired — get a new one.',
    connect_app_weixin_status_confirmed: 'Login confirmed. Tap Save & enable to write config.',
    connect_app_weixin_ready_save: 'WeChat login succeeded. Save & enable to finish.',
    connect_app_gateway_start_needed: 'Saved. Start or connect the chat gateway to apply.',
    platforms_panel_intro:
      'The Cosmius Hermes gateway (hermes-agent) can chat on Telegram, Discord, Feishu, WeCom, Slack, and more, plus OpenAI-compatible HTTP (api_server) and custom webhooks. Configure each under platforms.<name> in your active profile config.yaml.',
    platforms_yaml_block: 'config.yaml key',
    platforms_adapter_source: 'Adapter source (repo)',
    platforms_endpoints: 'Local HTTP endpoints',
    platforms_copy_url: 'Copy URL',
    platforms_copied: 'Copied',
    platforms_ready: 'Ready',
    platforms_incomplete: 'Incomplete',
    platforms_off: 'Off',
    platforms_empty: 'No platforms are defined in this profile.',
    platforms_load_error: 'Could not read gateway configuration.',
    platforms_agent_note:
      'Secrets stay in config.yaml or environment variables — this screen never shows tokens. Restart the hermes-agent gateway after you change config.',
    platforms_form_title: 'Edit configuration',
    platforms_save: 'Save to config.yaml',
    platforms_saved: 'Saved. Restart the hermes-agent gateway to apply.',
    platforms_save_failed: 'Save failed',
    platforms_secret_placeholder: 'Leave blank to keep the current value',
    platforms_secret_set_hint: 'A value is already stored in config.yaml for this field.',
    platforms_json_hint:
      'Valid JSON object. Secret values appear as bullets — keep those lines unchanged unless you want to replace them.',
    platforms_field_enabled: 'Enabled',
    platforms_field_token: 'Bot token',
    platforms_field_api_key: 'API key',
    platforms_field_reply_to_mode: 'Reply threading',
    platforms_field_extra_json: 'Extra (JSON)',
    platforms_field_app_id: 'App ID',
    platforms_field_app_secret: 'App secret',
    platforms_field_encrypt_key: 'Encrypt key',
    platforms_field_verification_token: 'Verification token',
    platforms_field_account_id: 'Account ID',
    platforms_field_bot_id: 'Bot ID',
    platforms_field_secret: 'Secret',
    platforms_field_websocket_url: 'WebSocket URL',
    platforms_field_client_id: 'Client ID',
    platforms_field_client_secret: 'Client secret',
    platforms_field_robot_code: 'Robot code',
    platforms_field_host: 'Listen host',
    platforms_field_port: 'Port',
    platforms_field_model_name: 'Model name',
    platforms_field_routes_json: 'Webhook routes (JSON object)',
    platforms_field_http_url: 'Signal HTTP URL',
    platforms_field_extra_url: 'Mattermost base URL',
    platforms_field_homeserver: 'Homeserver URL',
    platforms_field_user_id: 'Matrix user ID',
    platforms_field_password: 'Matrix password',
    platforms_weixin_web_intro:
      'Personal WeChat uses Tencent iLink. Use the in-app QR flow below (no terminal). After linking, click save to write config and reload the gateway.',
    platforms_weixin_bind_btn: 'Bind with WeChat (QR)',
    platforms_weixin_bind_hint:
      'Account ID and bot token are filled automatically after a successful scan. You can still adjust advanced URLs below.',
    platforms_weixin_modal_title: 'WeChat — scan to bind',
    platforms_weixin_qr_loading: 'Requesting QR code…',
    platforms_weixin_scan_wait: 'Open WeChat and scan the QR code.',
    platforms_weixin_scanned: 'Scanned — confirm on your phone.',
    platforms_weixin_qr_refreshed: 'The QR code was refreshed. Scan again.',
    platforms_weixin_confirmed: 'WeChat confirmed the link. Click the button below to save and enable.',
    platforms_weixin_open_link: 'If no image appears, open this link on the device that runs WeChat.',
    platforms_weixin_apply_btn: 'Save & enable',
    platforms_weixin_saved: 'Weixin configuration saved.',
    platforms_weixin_saved_restart_ok: 'Weixin saved and the gateway reload was requested.',
    platforms_saved_restart_ok: 'Saved. Gateway reload was requested (SIGUSR1).',
    platforms_field_weixin_account_id: 'iLink account ID (after QR login)',
    platforms_field_weixin_token: 'iLink bot token (optional)',
    platforms_field_weixin_token_hint:
      'Leave blank to keep the current value in config.yaml. The QR bind flow writes the token for you.',
    platforms_field_weixin_base_url: 'iLink API base URL',
    platforms_field_weixin_base_url_hint: 'Leave empty for default (ilinkai.weixin.qq.com or the URL returned at login).',
    platforms_field_weixin_cdn_base_url: 'Weixin CDN base URL',
    platforms_field_weixin_cdn_base_url_hint: 'Default is usually https://novac2c.cdn.weixin.qq.com/c2c — change only if iLink returns a different CDN base.',
    tab_settings: 'Settings',
    titlebar_view_version: 'Version',
    titlebar_view_version_hint: 'Cosmius Hermes agent version and mirror update',
    gateway_status_title: 'Gateway',
    gateway_status_running: 'Connected',
    gateway_status_stopped: 'Not running',
    gateway_status_checking: 'Checking…',
    gateway_status_error: 'Status unavailable',
    gateway_reload_btn: 'Reload',
    gateway_reload_ok: 'Reload signal sent to the gateway (SIGUSR1).',
    gateway_reload_fail: 'Reload was not applied.',
    gateway_reload_not_running: 'No gateway process found. Start the chat gateway (e.g. hermes gateway) for this profile, then try again.',
    gateway_start_ok: 'Gateway started in the background for this profile.',
    gateway_start_pending:
      'Gateway launch was requested; waiting for the process to register (status refreshes automatically).',
    gateway_start_failed: 'Could not start the gateway from the Web UI. Check the log path below or start it manually (e.g. hermes gateway).',
    gateway_reload_sigusr: 'Graceful reload is not available on this OS. Fully restart the gateway process.',
    titlebar_about_us: 'About us',
    titlebar_about_hint: 'Cosmius Hermes open-source components',
    titlebar_business_coop: 'Business cooperation',
    titlebar_business_coop_hint: 'Partnership and collaboration',
    titlebar_skill_market: 'Model Square',
    titlebar_skill_market_hint: 'Open Kyvolen Token platform',
    titlebar_update_label: 'Update',
    titlebar_github_hint: '',
    business_modal_title: 'Business cooperation',
    business_modal_mission:
      'We believe AI should be broadly accessible: individuals and organizations should be able to adopt it with less friction, instead of getting stuck in environment setup, deployment, and day-to-day ops. Intelligence should serve everyday work and learning for people who are not specialists in infrastructure.',
    business_modal_cta:
      'If this aligns with your vision, contact us by email to explore building together. Please mention Business cooperation in your message so we can route and reply faster.',
    business_modal_email_label: 'Email: ',
    about_modal_title: 'About us',
    feedback_btn_label: 'Logs',
    feedback_btn_title: 'Logs',
    feedback_modal_title: 'Logs',
    feedback_modal_desc: 'When a BUG appears, click "Export Logs" and send the generated zip file to us. Logs are automatically redacted and cleaned daily to avoid taking too much disk space.',
    feedback_step1_title: 'Logs',
    feedback_step1_desc: 'Current diagnostic logs are about 0.00 MB, cleaned daily, and exported files are retained for 24 hours.',
    feedback_step2_title: '',
    feedback_step2_desc: '',
    feedback_status_loading: 'Loading log status…',
    feedback_status_size: (mb) => `Current diagnostic logs are about ${mb} MB, cleaned daily, and exported files are retained for 24 hours.`,
    ...
    feedback_export_toast_ok: 'Logs exported.',
    feedback_export_toast_fail: (msg) => `Log export failed: ${msg}`,
    feedback_open_btn: '',
    feedback_open_toast: '',
    feedback_close_btn: 'Close',
    about_brand_name: 'Cosmius Hermes',
    about_channel_douyin: 'Cosmius Hermes',
    about_channel_feishu: 'Cosmius Hermes',
    about_community_blurb:
      'Cosmius Hermes brings the local agent, Web UI, Windows launcher, bundled runtime, and practical skills into one clean desktop experience for focused everyday AI work.',
    about_agent_heading: 'Cosmius Hermes Agent',
    about_agent_blurb:
      'Open-source AI agent runtime by Cosmius Hermes. It provides chat, tools, skills, scheduling, and gateway integrations used with this Web UI.',
    about_agent_copyright: 'Copyright (c) 2025 Cosmius Hermes',
    about_webui_heading: 'Cosmius Hermes Web UI',
    about_webui_blurb:
      'Open-source browser interface for Cosmius Hermes. This app bundles the Web UI with the agent for local use.',
    about_webui_copyright: 'Copyright (c) 2025 Cosmius Hermes Contributors',
    agent_version_loading: 'Loading\u2026',
    agent_version_modal_title: 'Cosmius Hermes agent',
    agent_version_branch: 'Mirror branch',
    agent_version_path: 'Agent path',
    agent_version_mirror_url_label: 'Mirror',
    agent_version_mirror_fallback_note: 'Primary mirror unreachable; using fallback:',
    agent_version_local_label: 'Local version',
    agent_version_release_label: 'Package version',
    agent_version_git_label: 'Git describe',
    agent_version_mirror_label: 'Mirror tip',
    agent_version_behind: '{n} commit(s) behind mirror',
    agent_version_maybe_behind: 'Mirror tip differs from your checkout (offline count unavailable).',
    agent_version_synced: 'Up to date with the mirror.',
    agent_version_no_agent: 'Agent checkout was not found on this server.',
    agent_version_no_git: 'This folder is not a Git clone; only the local label is shown.',
    agent_version_error: 'Could not read status: {msg}',
    agent_version_refresh: 'Refresh',
    agent_version_update_btn: 'Update via mirror',
    agent_version_update_confirm_title: 'Update Cosmius Hermes agent?',
    agent_version_update_confirm_message: 'Pulls the latest commit from the domestic Git mirror. The Web UI process will restart when finished.',
    agent_version_update_started: 'Updating from mirror — restarting\u2026',
    agent_version_update_failed: 'Update failed.',
    agent_toast_new_version: 'New hermes-agent build on mirror — click Version to update.',
    oc_btn_label: 'View Version',
    oc_btn_hint: 'Check Cosmius Hermes updates',
    oc_modal_title: 'Cosmius Hermes Update',
    oc_checking: 'Checking...',
    oc_current_version: 'Current version',
    oc_latest_version: 'Latest version',
    oc_update_available: 'New version found. Click the button below to update.',
    oc_up_to_date: 'Already up to date',
    oc_update_btn: 'Update',
    oc_downloading: 'Downloading...',
    oc_download_complete: 'Download complete',
    oc_install_btn: 'Install update',
    oc_update_failed: 'Update failed',
    oc_close_btn: 'Close',
    oc_refresh_btn: 'Refresh',
    oc_update_available_toast: 'New version found',
    ...
    settings_desc_bot_name: 'Display name for the assistant throughout the UI. Defaults to Cosmius Hermes.',
    ...
    providers_key_show: 'Show',
    providers_key_hide: 'Hide',
    providers_models_label: 'Models',
    providers_models_count: (n) => (n === 1 ? '1 model' : `${n} models`),
    providers_refresh_models: 'Refresh models',
    providers_load_failed: (msg) => `Failed to load providers: ${msg}`,
    cancel: 'Cancel',
    ...
    onboarding_title: 'Welcome to Cosmius Hermes',
    onboarding_lead: 'A quick guided setup will verify Cosmius Hermes, save a real provider configuration, choose a workspace and model, and optionally protect the app with a password.',
    onboarding_back: 'Back',
    onboarding_continue: 'Continue',
    onboarding_skip: 'Skip setup',
    onboarding_skipped: 'Setup skipped — using existing config.',
    onboarding_open: 'Open Cosmius Hermes',
    onboarding_step_system_title: 'System check',
    onboarding_step_system_desc: 'Verify Cosmius Hermes Agent and config visibility.',
    onboarding_step_setup_title: 'Provider setup',
    onboarding_step_setup_desc: 'Save the minimum Cosmius Hermes provider config.',
    ...
    onboarding_notice_system_ready: 'Cosmius Hermes Agent looks reachable from the Web UI.',
    onboarding_notice_system_unavailable: 'Cosmius Hermes Agent is not fully available yet. Bootstrap can install it, but provider setup may still require a terminal.',
    onboarding_check_agent: 'Cosmius Hermes Agent',
    ...
    onboarding_notice_setup_required: 'Choose a simple provider path here. Advanced OAuth flows still belong in the Cosmius Hermes CLI for now.',
    onboarding_notice_setup_already_ready: 'A working Cosmius Hermes provider setup is already detected. You can keep it or replace it here.',
    onboarding_oauth_provider_ready_title: 'Provider already authenticated',
    onboarding_oauth_provider_ready_body: 'This instance is configured to use an OAuth provider (<strong>{provider}</strong>) that was set up via the Cosmius Hermes CLI. No API key is needed here — click Continue to finish setup.',
    ...
    onboarding_models_fetching: 'Loading available chat models from the provider…',
    onboarding_models_live_failed: 'Could not refresh the live model list; using the built-in catalog or manual entry.',
    onboarding_selfcheck_failed_can_skip: 'The upstream API may be reachable, but the initialization self-check failed. You can skip setup and configure the key manually from the sidebar.',
    onboarding_workspace_model_manual_hint: 'No online model list was returned. Enter the exact chat model id your server expects.',
    onboarding_workspace_label: 'Workspace',
    onboarding_workspace_or_path: 'Or enter a workspace path',
    onboarding_workspace_browse: 'Browse…',
    onboarding_workspace_browse_title: 'Choose workspace directory',
    onboarding_workspace_browse_hint:
      'If no system folder dialog appeared, pick from this server-side list (home directory, saved workspaces, or default workspace only).',
    onboarding_workspace_browse_up: 'Parent folder',
    onboarding_workspace_browse_use: 'Use this folder',
    onboarding_workspace_browse_empty: 'No subfolders here.',
    onboarding_workspace_browse_load_failed: 'Could not load folder list.',
    onboarding_workspace_browse_loading: 'Loading folders…',
    onboarding_workspace_browse_roots: 'Starting locations',
    workspace_picker_title: 'Select workspace folder',
    workspace_picker_hint: 'Pick a local Windows folder for this conversation workspace.',
    workspace_picker_current_label: 'Current workspace',
    workspace_picker_native_title: 'Choose a folder from this PC',
    workspace_picker_native_hint: 'A Windows folder dialog will open on this machine. Select the folder you want Cosmius Hermes to use as the workspace.',
    workspace_picker_native_button: 'Choose local folder',
    workspace_picker_native_opening: 'Opening the Windows folder picker...',
    workspace_picker_native_switching: 'Switching workspace...',
    workspace_picker_native_cancelled: 'Folder selection cancelled.',
    workspace_picker_native_unavailable: 'Native folder picker is unavailable here. Use the backup browser below.',
    workspace_picker_native_failed: 'Could not open folder picker.',
    workspace_picker_fallback_title: 'Backup server folder browser',
    workspace_picker_saved: 'Saved workspaces',
    workspace_picker_use: 'Use current folder',
    ...
    provider_label_custom: 'Custom model',
    onboarding_api_key_label: 'API key',
    onboarding_api_key_placeholder: 'Leave blank to keep an existing saved key',
    onboarding_api_key_help_prefix: 'Saved as a secret in your Cosmius Hermes .env file using',
    ...
    onboarding_base_url_preset_label: 'Endpoint preset',
    onboarding_deepseek_preset_default: 'Default API host (api.deepseek.com)',
    onboarding_deepseek_preset_openai_v1: 'OpenAI-compatible path (/v1)',
    onboarding_deepseek_base_url_hint:
      'DeepSeek public API uses one global host; some OpenAI-compatible stacks expect the /v1 suffix. Pick a preset or edit the URL if your client docs say otherwise.',
    onboarding_model_label: 'Default model',
    onboarding_workspace_help: 'Pick the model Cosmius Hermes should use for new chats after setup completes.',
    ...
    cron_failed_no_output: (name) => `定时任务 \"\" 执行完成但无输出，可能是模型配置错误。请到设置中检查模型 ID。`,
    cron_failed_generic: (name) => `定时任务 \"\" 执行失败。请查看日志了解详情。`,
    ...
    workspace_use: 'Use',
    workspace_files_title: 'Files',
    workspace_files_empty: 'Directory is empty',
    workspace_files_more: (n) => `...and ${n} more items`,   // EN
  ...
  ja: {
    ...
    cmd_skills: '利用可能な Cosmius Hermes スキルを一覧表示',
  ...
  status_agent_running:'エージェント実行中',
    ...
    status_hermes_home: 'Cosmius Hermes ホーム',
    status_started: '開始',
    status_tokens: 'トークン',
  ...
  folder_add_as_space_title: 'スペースとして追加?',
    ...
    settings_section_preferences_meta: 'Cosmius Hermes のデフォルトと UI 動作。',
    ...
    tab_insights: 'インサイト',
    tab_settings: '設定',
    titlebar_view_version: 'バージョン',
    titlebar_view_version_hint: 'Cosmius Hermesエージェントのバージョンとミラー更新',
    agent_version_loading: '読み込み中\u2026',
    agent_version_modal_title: 'Cosmius Hermes エージェント',
    agent_version_branch: 'ミラーブランチ',
    agent_version_path: 'エージェントのパス',
    agent_version_mirror_url_label: 'ミラーURL',
    agent_version_mirror_fallback_note: 'プライマリミラーに接続できないためフォールバックを使用:',
    agent_version_local_label: 'ローカル',
    agent_version_mirror_label: 'ミラー先端',
    agent_version_behind: 'ミラーより {n} コミット遅れ',
    agent_version_maybe_behind: 'ミラーの先端がローカルと異なります（件数未確認）。',
    agent_version_synced: 'ミラーと同期済みです。',
    agent_version_no_agent: 'エージェントのチェックアウトが見つかりません。',
    agent_version_no_git: 'Git リポジトリではありません。',
    agent_version_error: '状態を取得できません: {msg}',
    agent_version_refresh: '再読み込み',
    agent_version_update_btn: 'ミラーから更新',
    agent_version_update_confirm_title: 'エージェントを更新しますか？',
    agent_version_update_confirm_message: '国内ミラーの最新コミットを取り込みます。完了後にサーバーが再起動します。',
    agent_version_update_started: 'ミラーから更新中\u2026 再起動します',
    agent_version_update_failed: '更新に失敗しました。',
    agent_toast_new_version: 'ミラーに新しい hermes-agent があります。「バージョン」から更新してください。',
    ...
    settings_desc_bot_name: 'UI 全体で表示されるアシスタントの名前。デフォルトは Cosmius Hermes。',
    ...
    providers_key_show: '表示',
    providers_key_hide: '隠す',
    providers_models_label: 'モデル',
    providers_models_count: (n) => (n === 1 ? 'モデル 1 件' : `モデル ${n} 件`),
    providers_refresh_models: 'モデルを再取得',
    providers_load_failed: (msg) => `プロバイダの読み込みに失敗しました: ${msg}`,
    cancel: 'キャンセル',
    create_job: 'ジョブを作成',
    save_skill: 'スキルを保存',
    editing: '編集中',
    ...
    onboarding_language_label: '言語',
    onboarding_title: 'Cosmius Hermes へようこそ',
    onboarding_lead: 'クイックガイドで Cosmius Hermes を確認し、プロバイダ設定を保存し、ワークスペースとモデルを選択し、必要ならパスワードでアプリを保護します。',
    onboarding_back: '戻る',
    onboarding_continue: '続ける',
    onboarding_skip: 'セットアップをスキップ',
    onboarding_skipped: 'セットアップをスキップ — 既存設定を使用します。',
    onboarding_open: 'Cosmius Hermes を開く',
    onboarding_step_system_title: 'システム確認',
    onboarding_step_system_desc: 'Cosmius Hermes Agent と設定の可視性を確認します。',
    onboarding_step_setup_title: 'プロバイダ設定',
    onboarding_step_setup_desc: '最低限の Cosmius Hermes プロバイダ設定を保存します。',
    ...
    onboarding_notice_system_ready: 'Web UI から Cosmius Hermes Agent へ到達できそうです。',
    onboarding_notice_system_unavailable: 'Cosmius Hermes Agent はまだ完全には利用できません。Bootstrap でインストールできますが、プロバイダ設定にはターミナルが必要な場合があります。',
    onboarding_check_agent: 'Cosmius Hermes Agent',
    ...
    onboarding_notice_setup_required: 'シンプルなプロバイダ経路をここで選んでください。高度な OAuth フローは現状 Cosmius Hermes CLI 側で扱います。',
    onboarding_notice_setup_already_ready: '動作する Cosmius Hermes プロバイダ設定が既に検出されています。維持するか、ここで置き換えできます。',
    onboarding_oauth_provider_ready_title: 'プロバイダは認証済み',
    onboarding_oauth_provider_ready_body: 'このインスタンスは Cosmius Hermes CLI で設定された OAuth プロバイダ (<strong>{provider}</strong>) を使用します。APIキーは不要 — 続けるをクリックしてセットアップを完了してください。',
    ...
    onboarding_api_key_help_prefix: 'Cosmius Hermes の .env ファイルにシークレットとして保存されます — 使用変数:',
    ...
    onboarding_workspace_help: 'セットアップ完了後の新規チャットで Cosmius Hermes が使用するモデルを選択してください。',
    onboarding_custom_model_placeholder: 'your-model-name',
    ...
    workspace_files_title: '\u5de5\u4f5c\u533a\u6587\u4ef6',
    workspace_files_empty: '\u76ee\u5f55\u4e3a\u7a7a',
    workspace_files_more: (n) => `...还有 ${n} 个项目`,
    workspace_use: '使用',
  ...
  ru: {
    ...
    cmd_skills: 'Показать доступные навыки Cosmius Hermes',
  ...
  folder_add_as_space_title: 'Добавить как пространство?',
    ...
    settings_desc_sync_insights: 'Синхронизирует использование токенов WebUI в state.db, чтобы Cosmius Hermes /insights включал данные браузерных сеансов. Выключено по умолчанию.',
    ...
    settings_desc_bot_name: 'Отображаемое имя помощника во всём интерфейсе. По умолчанию Cosmius Hermes.',
    ...
    onboarding_language_label: 'Язык',
    onboarding_title: 'Добро пожаловать в Cosmius Hermes',
    onboarding_lead: 'Краткая пошаговая настройка проверит Cosmius Hermes, сохранит рабочую конфигурацию провайдера, выберет рабочее пространство и модель и при желании защитит приложение паролем.',
    ...
    onboarding_open: 'Открыть Cosmius Hermes',
    onboarding_step_system_title: 'Проверка системы',
    onboarding_step_system_desc: 'Проверить Cosmius Hermes Agent и видимость конфигурации.',
    onboarding_step_setup_title: 'Настройка провайдера',
    onboarding_step_setup_desc: 'Сохранить минимальную рабочую конфигурацию провайдера Cosmius Hermes.',
    ...
    onboarding_notice_system_ready: 'Cosmius Hermes Agent, похоже, доступен из Web UI.',
    onboarding_notice_system_unavailable: 'Cosmius Hermes Agent ещё не полностью доступен. Bootstrap может установить его, но для настройки провайдера всё ещё может понадобиться терминал.',
    onboarding_check_agent: 'Cosmius Hermes Agent',
    ...
    onboarding_notice_setup_required: 'Выберите здесь простой путь настройки провайдера. Продвинутые OAuth-сценарии пока остаются в Cosmius Hermes CLI.',
    onboarding_notice_setup_already_ready: 'Уже обнаружена рабочая конфигурация провайдера Cosmius Hermes. Вы можете оставить её или заменить здесь.',
    onboarding_oauth_provider_ready_title: 'Провайдер уже авторизован',
    onboarding_oauth_provider_ready_body: 'Этот экземпляр настроен на использование OAuth-провайдера (<strong>{provider}</strong>), настроенного через Cosmius Hermes CLI. API-ключ здесь не нужен — нажмите «Продолжить», чтобы завершить настройку.',
    ...
    onboarding_api_key_help_prefix: 'Сохраняется как секрет в вашем файле `.env` Cosmius Hermes с помощью',
    ...
    onboarding_workspace_help: 'Выберите модель, которую Cosmius Hermes должен использовать для новых чатов после завершения настройки.',
  ...
  es: {
    ...
    cmd_skills: 'Listar las skills de Cosmius Hermes disponibles',
  ...
  folder_add_as_space_title: '¿Añadir como espacio?',
    ...
    settings_desc_bot_name: 'Nombre visible del asistente en toda la UI. Por defecto es Cosmius Hermes.',
    ...
    onboarding_language_label: 'Idioma',
    onboarding_title: 'Bienvenido a Cosmius Hermes',
    onboarding_lead: 'Una guía rápida verificará Cosmius Hermes, guardará una configuración real del proveedor, elegirá un espacio de trabajo y un modelo, y opcionalmente protegerá la app con una contraseña.',
    ...
    onboarding_open: 'Abrir Cosmius Hermes',
    onboarding_step_system_title: 'Comprobación del sistema',
    onboarding_step_system_desc: 'Verifica Cosmius Hermes Agent y la visibilidad de la configuración.',
    onboarding_step_setup_title: 'Configuración del proveedor',
    onboarding_step_setup_desc: 'Guarda la configuración mínima real de Cosmius Hermes.',
    ...
    onboarding_notice_system_ready: 'Parece que Cosmius Hermes Agent está accesible desde la Web UI.',
    onboarding_notice_system_unavailable: 'Cosmius Hermes Agent todavía no está totalmente disponible. Bootstrap puede instalarlo, pero la configuración del proveedor quizá aún requiera una terminal.',
    onboarding_check_agent: 'Cosmius Hermes Agent',
    ...
    onboarding_notice_setup_required: 'Elige aquí una ruta simple de proveedor. Los flujos OAuth avanzados siguen siendo del CLI de Cosmius Hermes por ahora.',
    onboarding_notice_setup_already_ready: 'Ya se detectó una configuración funcional del proveedor de Cosmius Hermes. Puedes conservarla o reemplazarla aquí.',
    onboarding_oauth_provider_ready_title: 'Proveedor ya autenticado',
    onboarding_oauth_provider_ready_body: 'Esta instancia está configurada para usar un proveedor OAuth (<strong>{provider}</strong>) configurado mediante la CLI de Cosmius Hermes. No se necesita clave API aquí — haz clic en Continuar para finalizar la configuración.',
    ...
    oauth_codex_error: 'OAuth login failed', // TODO: translate
    oauth_codex_expired: 'Code expired, please try again', // TODO: translate
    onboarding_api_key_help_prefix: 'Se guarda como secreto en tu archivo .env de Cosmius Hermes usando',
    onboarding_base_url_label: 'Base URL',
    ...
    onboarding_workspace_help: 'Elige el modelo que Cosmius Hermes debe usar para nuevos chats cuando termine la configuración.',
  ...
  de: {
    ...
    cmd_skills: 'Verfügbare Cosmius Hermes-Skills auflisten',
  ...
  folder_add_as_space_title: 'Als Bereich hinzufügen?',
    ...
    settings_desc_bot_name: 'Anzeigename für den Assistenten in der UI. Standardmäßig Cosmius Hermes.',
    ...
    onboarding_language_label: 'Sprache',
    onboarding_title: 'Willkommen bei Cosmius Hermes',
    ...
    onboarding_step_system_desc: 'Cosmius Hermes Agent muss installiert und erreichbar sein.',
    ...
    onboarding_notice_system_unavailable: 'Agent nicht erreichbar. Bitte starten Sie Cosmius Hermes Agent.',
  ...
  zh: {
    ...
    model_error_label_not_found: '\u672a\u627e\u5230\u6a21\u578b',
    model_error_label_auth: 'API Key \u9519\u8bef',
    model_error_label_generic: '\u6a21\u578b\u914d\u7f6e\u9519\u8bef',
    model_error_hint_prefix: '\u539f\u56e0\uff1a',
    model_error_fix_btn: '\u53bb\u8bbe\u7f6e',
    model_error_dismiss_btn: '\u5ffd\u7565',
    ...
    cmd_skills: '\u5217\u51fa\u53ef\u7528\u7684 Cosmius Hermes \u6280\u80fd',
  ...
  folder_add_as_space_title: '\u6dfb\u52a0\u4e3a\u5de5\u4f5c\u533a\uff1f',
    ...
    settings_factory_reset_title: '\u91cd\u7f6e\u521d\u59cb\u914d\u7f6e',
    settings_factory_reset_desc: '\u6e05\u9664\u63d0\u4f9b\u5546/\u6a21\u578b\u8bbe\u7f6e\u3001\u5feb\u901f\u914d\u7f6e API key \u548c Web UI \u5bc6\u7801\uff0c\u7136\u540e\u91cd\u65b0\u6253\u5f00\u9996\u6b21\u8fd0\u884c\u5411\u5bfc\u3002\u804a\u5929\u4f1a\u8bdd\u4f1a\u4fdd\u7559\u3002',
    settings_factory_reset_btn: '\u91cd\u7f6e\u521d\u59cb\u914d\u7f6e\u2026',
    settings_factory_reset_prompt: '\u786e\u5b9a\u8981\u6e05\u9664\u63d0\u4f9b\u5546/\u6a21\u578b\u8bbe\u7f6e\u3001\u5feb\u901f\u914d\u7f6e API key \u548c Web UI \u5bc6\u7801\uff0c\u5e76\u91cd\u65b0\u6253\u5f00\u9996\u6b21\u8fd0\u884c\u5411\u5bfc\u5417\uff1f\u804a\u5929\u4f1a\u8bdd\u4f1a\u4fdd\u7559\u3002',
    settings_factory_reset_password_prompt: '\u5df2\u542f\u7528\u8bbf\u95ee\u5bc6\u7801\u3002\u8bf7\u8f93\u5165\u5bc6\u7801\u4ee5\u6388\u6743\u6b64\u6e05\u9664\uff1a',
    settings_factory_reset_done: '\u5df2\u91cd\u7f6e\u521d\u59cb\u914d\u7f6e\u3002',
    settings_factory_reset_failed: '\u91cd\u7f6e\u521d\u59cb\u914d\u7f6e\u5931\u8d25\uff1a',
    ...
    tab_insights: '统计',
    tab_platforms: '聊天平台',
    platforms_main_sidebar_hint: '在左侧列表选择平台；配置抽屉会覆盖在列表上，完成后点击保存。',
    connect_app_title: '连接应用',
    connect_app_subtitle: '配置并启用消息平台集成。',
    connect_app_search_placeholder: '搜索平台…',
    connect_app_filter_all: '全部',
    connect_app_group_top_picks: '优先推荐',
    connect_app_group_international_im: '国际即时通讯',
    connect_app_group_china_workplace_wechat: '国内办公与微信生态',
    connect_app_group_open_interfaces: '开放接口',
    connect_app_group_traditional_channels: '传统通道',
    connect_app_group_others: '其它',
    connect_app_status_not_configured: '未配置',
    connect_app_status_configured: '已配置（未连接）',
    connect_app_status_connected: '已连接',
    connect_app_status_error: '连接异常',
    connect_app_configure: '配置',
    connect_app_save_enable: '保存并启用',
    connect_app_test_connection: '测试连接',
    connect_app_disable: '停用',
    connect_app_required: '必填',
    connect_app_optional: '可选',
    connect_app_advanced: '高级项',
    connect_app_saved_enabled: '保存成功，已启用。',
    connect_app_test_success: '连接测试成功。',
    connect_app_test_failed_kept: '连接测试失败，但配置已保留。',
    connect_app_disabled: '已停用。',
    connect_app_weixin_qr_intro:
      '个人微信走腾讯 iLink：生成二维码后用微信扫描，确认后点击「保存并启用」写入配置。',
    connect_app_weixin_get_qr: '获取二维码',
    connect_app_weixin_open_link: '在浏览器打开扫码链接',
    connect_app_weixin_requesting: '正在请求二维码…',
    connect_app_weixin_status_wait: '等待扫码…',
    connect_app_weixin_status_scaned: '已扫码，请在手机微信中确认…',
    connect_app_weixin_status_redirect: '正在切换登录区域…',
    connect_app_weixin_status_expired: '二维码已过期，请重新获取。',
    connect_app_weixin_status_confirmed: '登录已确认，请点击「保存并启用」写入配置。',
    connect_app_weixin_ready_save: '微信登录成功，请点击「保存并启用」完成配置。',
    connect_app_gateway_start_needed: '已保存。请启动或连接聊天网关后生效。',
    platforms_panel_intro:
      'Cosmius Hermes \u7f51\u5173\uff08hermes-agent\uff09\u53ef\u63a5\u5165 Telegram\u3001Discord\u3001\u98de\u4e66\u3001\u4f01\u5fae\u3001Slack \u7b49\u804a\u5929\u5e73\u53f0\uff0c\u4e5f\u652f\u6301 OpenAI \u517c\u5bb9 HTTP\uff08api_server\uff09\u4e0e\u81ea\u5b9a\u4e49 webhook\u3002\u5728\u5f53\u524d profile \u7684 config.yaml \u4e2d\u914d\u7f6e platforms.<\u540d\u79f0>\u3002',
    platforms_yaml_block: 'config.yaml \u952e',
    platforms_adapter_source: '\u9002\u914d\u5668\u6e90\u7801\uff08\u4ed3\u5e93\uff09',
    platforms_endpoints: '\u672c\u5730 HTTP \u5730\u5740',
    platforms_copy_url: '\u590d\u5236\u94fe\u63a5',
    platforms_copied: '\u5df2\u590d\u5236',
    platforms_ready: '\u5df2\u914d\u7f6e',
    platforms_incomplete: '\u672a\u5b8c\u6210',
    platforms_off: '\u672a\u542f\u7528',
    platforms_empty: '\u6b64 profile \u4e2d\u672a\u5b9a\u4e49\u5e73\u53f0\u3002',
    platforms_load_error: '\u65e0\u6cd5\u8bfb\u53d6\u7f51\u5173\u914d\u7f6e\u3002',
    platforms_agent_note:
      '\u51ed\u8bc1\u4fdd\u7559\u5728 config.yaml \u6216\u73af\u5883\u53d8\u91cf\u4e2d\uff0c\u6b64\u9875\u4e0d\u4f1a\u663e\u793a Token\u3002\u4fee\u6539\u914d\u7f6e\u540e\u8bf7\u91cd\u542f hermes-agent \u7f51\u5173\u8fdb\u7a0b\u3002',
    platforms_form_title: '\u7f16\u8f91\u914d\u7f6e',
    platforms_save: '\u4fdd\u5b58\u5230 config.yaml',
    platforms_saved: '\u5df2\u4fdd\u5b58\u3002\u8bf7\u91cd\u542f hermes-agent \u7f51\u5173\u4ee5\u751f\u6548\u3002',
    platforms_save_failed: '\u4fdd\u5b58\u5931\u8d25',
    platforms_secret_placeholder: '\u7559\u7a7a\u5219\u4fdd\u6301\u5f53\u524d\u503c\u4e0d\u53d8',
    platforms_secret_set_hint: 'config.yaml \u4e2d\u5df2\u5b58\u50a8\u8be5\u5b57\u6bb5\u7684\u503c\u3002',
    platforms_json_hint:
      '\u5408\u6cd5 JSON \u5bf9\u8c61\u3002\u654f\u611f\u503c\u663e\u793a\u4e3a\u5706\u70b9\u884c\u2014\u2014\u82e5\u4e0d\u66f4\u6539\u8bf7\u4fdd\u7559\u8fd9\u4e9b\u884c\u3002',
    platforms_field_enabled: '\u542f\u7528',
    platforms_field_token: 'Bot Token',
    platforms_field_api_key: 'API Key',
    platforms_field_reply_to_mode: '\u56de\u590d\u7f16\u6392',
    platforms_field_extra_json: 'Extra\uff08JSON\uff09',
    platforms_field_app_id: 'App ID',
    platforms_field_app_secret: 'App Secret',
    platforms_field_encrypt_key: '\u52a0\u5bc6 Key',
    platforms_field_verification_token: '\u6821\u9a8c Token',
    platforms_field_account_id: '\u8d26\u53f7 ID',
    platforms_field_bot_id: 'Bot ID',
    platforms_field_secret: 'Secret',
    platforms_field_websocket_url: 'WebSocket \u5730\u5740',
    platforms_field_client_id: 'Client ID',
    platforms_field_client_secret: 'Client Secret',
    platforms_field_robot_code: 'Robot Code',
    platforms_field_host: '\u76d1\u542c\u5730\u5740',
    platforms_field_port: '\u7aef\u53e3',
    platforms_field_model_name: '\u6a21\u578b\u540d',
    platforms_field_routes_json: 'Webhook \u8def\u7531\uff08JSON\uff09',
    platforms_field_http_url: 'Signal HTTP URL',
    platforms_field_extra_url: 'Mattermost \u57fa\u7840 URL',
    platforms_field_homeserver: 'Homeserver URL',
    platforms_field_user_id: 'Matrix \u7528\u6237 ID',
    platforms_field_password: 'Matrix \u5bc6\u7801',
    platforms_weixin_web_intro:
      '\u4e2a\u4eba\u5fae\u4fe1\u8d70\u817e\u8baf iLink\uff1a\u5728\u6b64\u9875\u9762\u7528\u5fae\u4fe1\u626b\u63cf\u4e8c\u7ef4\u7801\u5373\u53ef\uff08\u65e0\u9700\u7ec8\u7aef\uff09\u3002\u626b\u7801\u6210\u529f\u540e\u70b9\u300c\u4fdd\u5b58\u5e76\u542f\u7528\u300d\u5199\u5165\u914d\u7f6e\u5e76\u5c1d\u8bd5\u91cd\u8f7d\u7f51\u5173\u3002',
    platforms_weixin_bind_btn: '\u5fae\u4fe1\u626b\u7801\u7ed1\u5b9a',
    platforms_weixin_bind_hint:
      '\u626b\u7801\u6210\u529f\u540e\u4f1a\u81ea\u52a8\u586b\u5165\u8d26\u53f7 ID \u4e0e bot token\uff1b\u4ecd\u53ef\u5728\u4e0b\u65b9\u8c03\u6574\u9ad8\u7ea7 URL\u3002',
    platforms_weixin_modal_title: '\u5fae\u4fe1 \u2014 \u626b\u7801\u7ed1\u5b9a',
    platforms_weixin_qr_loading: '\u6b63\u5728\u83b7\u53d6\u4e8c\u7ef4\u7801\u2026',
    platforms_weixin_scan_wait: '\u8bf7\u7528\u5fae\u4fe1\u626b\u63cf\u4e0b\u65b9\u4e8c\u7ef4\u7801\u3002',
    platforms_weixin_scanned: '\u5df2\u626b\u7801\uff0c\u8bf7\u5728\u624b\u673a\u4e0a\u786e\u8ba4\u3002',
    platforms_weixin_qr_refreshed: '\u4e8c\u7ef4\u7801\u5df2\u5237\u65b0\uff0c\u8bf7\u91cd\u65b0\u626b\u63cf\u3002',
    platforms_weixin_confirmed: '\u5df2\u5728\u5fae\u4fe1\u786e\u8ba4\u7ed1\u5b9a\u3002\u70b9\u51fb\u4e0b\u65b9\u6309\u94ae\u4fdd\u5b58\u5e76\u542f\u7528\u3002',
    platforms_weixin_open_link: '\u82e5\u672a\u663e\u793a\u56fe\u7247\uff0c\u8bf7\u5728\u5df2\u5b89\u88c5\u5fae\u4fe1\u7684\u8bbe\u5907\u4e0a\u6253\u5f00\u6b64\u94fe\u63a5\u3002',
    platforms_weixin_apply_btn: '\u4fdd\u5b58\u5e76\u542f\u7528',
    platforms_weixin_saved: '\u5fae\u4fe1\u914d\u7f6e\u5df2\u4fdd\u5b58\u3002',
    platforms_weixin_saved_restart_ok: '\u5df2\u4fdd\u5b58\uff0c\u5df2\u5411\u7f51\u5173\u53d1\u8d77\u91cd\u8f7d\u8bf7\u6c42\u3002',
    platforms_saved_restart_ok: '\u5df2\u4fdd\u5b58\u3002\u5df2\u5411\u7f51\u5173\u53d1\u8d77\u91cd\u8f7d\u8bf7\u6c42\uff08SIGUSR1\uff09\u3002',
    platforms_field_weixin_account_id: 'iLink \u8d26\u53f7 ID\uff08\u626b\u7801\u767b\u5f55\u540e\uff09',
    platforms_field_weixin_token: 'iLink bot token\uff08\u53ef\u9009\uff09',
    platforms_field_weixin_token_hint:
      '\u7559\u7a7a\u5219\u4fdd\u6301 config.yaml \u91cc\u8be5\u5b57\u6bb5\u73b0\u6709\u503c\u4e0d\u53d8\u3002\u626b\u7801\u7ed1\u5b9a\u6d41\u7a0b\u4f1a\u81ea\u52a8\u5199\u5165 token\u3002',
    platforms_field_weixin_base_url: 'iLink API \u57fa\u7840 URL',
    platforms_field_weixin_base_url_hint: '\u7559\u7a7a\u5219\u7528\u9ed8\u8ba4\uff08ilinkai.weixin.qq.com \u6216\u767b\u5f55\u8fd4\u56de\u7684\u5730\u5740\uff09\u3002',
    platforms_field_weixin_cdn_base_url: '\u5fae\u4fe1 CDN \u57fa\u7840 URL',
    platforms_field_weixin_cdn_base_url_hint:
      '\u9ed8\u8ba4\u901a\u5e38\u4e3a https://novac2c.cdn.weixin.qq.com/c2c \u2014\u2014 \u4ec5\u5728 iLink \u8fd4\u56de\u5176\u4ed6\u503c\u65f6\u518d\u6539\u3002',
    tab_workspaces: '工作区',
    tab_profiles: '配置',
    tab_settings: '设置',
    titlebar_view_version: '查看版本',
    titlebar_view_version_hint: '查看 Cosmius Hermes Agent 版本与国内镜像状态',
    gateway_status_title: '网关',
    gateway_status_running: '已连接',
    gateway_status_stopped: '未运行',
    gateway_status_checking: '检测中…',
    gateway_status_error: '状态不可用',
    gateway_reload_btn: '重载',
    gateway_reload_ok: '已向网关发送重载信号（SIGUSR1）。',
    gateway_reload_fail: '未能完成重载。',
    gateway_reload_not_running: '未发现网关进程。请在本机启动聊天网关（如 hermes gateway）后再试。',
    gateway_start_ok: '已在后台为本配置启动网关。',
    gateway_start_pending: '已请求启动网关，正在等待进程注册（状态将自动刷新）。',
    gateway_start_failed: '无法从界面启动网关。请查看下方日志路径，或在终端运行 hermes gateway。',
    gateway_reload_sigusr: '当前系统不支持 SIGUSR1 优雅重载，请完全重启网关进程。',
    titlebar_about_us: '关于我们',
    titlebar_about_hint: '开源组件简介',
    titlebar_business_coop: '商务合作',
    titlebar_business_coop_hint: '商务与共创垂询',
    titlebar_skill_market: '模型广场',
    titlebar_skill_market_hint: '打开Kyvolen Token平台',
    titlebar_update_label: '更新',
    titlebar_github_hint: '',
    business_modal_title: '商务合作',
    business_modal_mission:
      '我们致力于推动人工智能的普惠化，让个人与组织都能以更低门槛、更顺畅的方式使用 AI，而不是长期受限于环境搭建、部署与运维等环节；使智能技术真正服务于非技术背景的日常工作与学习场景。',
    business_modal_cta:
      '若您或您的机构与我们有相同愿景，欢迎通过邮箱与我们联系、共探合作。留言时请备注「商务合作」，便于我们尽快与您对接。',
    business_modal_email_label: '邮箱：',
    about_modal_title: '关于我们',
    feedback_btn_label: '日志',
    feedback_btn_title: '日志',
    feedback_modal_title: '日志',
    feedback_modal_desc: '当出现 BUG时，请点击"导出日志"，将生成的zip文件发送给我们。日志会自动脱敏，并每日清理，避免占用过多磁盘空间。',
    feedback_step1_title: '日志',
    feedback_step1_desc: '当前诊断日志约0.00 MB，每日自动清理，导出文件保留24小时。',
    feedback_step2_title: '',
    feedback_step2_desc: '',
    ...
    about_channel_feishu: 'Cosmius Hermes',
    about_community_blurb:
      'Cosmius Hermes 将本地 Agent、Web UI、Windows 启动器、运行时与实用技能整合为一个干净的桌面体验，服务日常 AI 工作流。',
    about_agent_heading: 'Cosmius Hermes Agent',
    about_agent_blurb:
      '由 Cosmius Hermes 维护的开源 AI Agent 运行时，为本界面提供对话、工具、技能、定时任务与网关等能力。',
    about_agent_copyright: 'Copyright (c) 2025 Cosmius Hermes',
    about_webui_heading: 'Cosmius Hermes Web UI',
    about_webui_blurb: '与 Cosmius Hermes 配套的开源浏览器界面；本应用在本地组合 Web UI 与 Agent 以便使用。',
    about_webui_copyright: 'Copyright (c) 2025 Cosmius Hermes Contributors',
    agent_version_loading: '加载中\u2026',
    agent_version_modal_title: 'Cosmius Hermes Agent 版本',
    agent_version_branch: '镜像分支',
    agent_version_path: 'Agent 路径',
    agent_version_mirror_url_label: '镜像地址',
    agent_version_mirror_fallback_note: '主镜像不可用，已自动使用备用镜像：',
    agent_version_local_label: '本地版本',
    agent_version_release_label: '发行版本',
    agent_version_git_label: 'Git 描述',
    agent_version_mirror_label: '镜像最新提交',
    agent_version_behind: '落后镜像 {n} 个提交',
    agent_version_maybe_behind: '镜像端与本地提交不一致（无法拉取以精确计数）。',
    agent_version_synced: '已与镜像同步。',
    agent_version_no_agent: '未在此服务器上找到 Agent 目录。',
    agent_version_no_git: '当前目录不是 Git 仓库，仅显示本地标签。',
    agent_version_error: '无法读取状态：{msg}',
    agent_version_refresh: '刷新',
    agent_version_update_btn: '通过国内镜像更新',
    agent_version_update_confirm_title: '通过镜像更新 Agent？',
    agent_version_update_confirm_message: '将从国内 Git 镜像拉取最新提交；完成后 Web 服务会重启。',
    agent_version_update_started: '正在从镜像更新并重启\u2026',
    agent_version_update_failed: '更新失败。',
    agent_toast_new_version: '镜像上有新的 hermes-agent 版本，请点击「查看版本」更新。',
    oc_btn_label: '查看版本',
    oc_btn_hint: '检查 Cosmius Hermes 更新',
    oc_modal_title: 'Cosmius Hermes 更新',
    oc_checking: '检查更新中…',
    oc_current_version: '当前版本',
    oc_latest_version: '最新版本',
    oc_update_available: '发现新版本，点击下方按钮更新',
    oc_up_to_date: '已是最新版本',
    oc_update_btn: '立即更新',
    oc_confirm_title: '确认更新',
    oc_confirm_message: '将下载最新安装包并自动运行。安装程序启动后，请按提示完成安装。',
    oc_downloading: '下载中…',
    ...
    sign_out: '退出登录',
    // Providers panel
    providers_tab_title: '\u6a21\u578b\u63d0\u4f9b\u5546',
    providers_section_title: '\u6a21\u578b\u63d0\u4f9b\u5546',
    providers_section_meta: '\u7ba1\u7406 AI \u63d0\u4f9b\u5546\u7684 API \u5bc6\u94a5\uff0c\u4fee\u6539\u540e\u7acb\u5373\u751f\u6548\u3002',
    ...
    providers_oauth_hint: '\u5df2\u901a\u8fc7 OAuth \u8ba4\u8bc1\uff0c\u65e0\u9700 API \u5bc6\u94a5\u3002',
    providers_oauth_config_yaml_hint: '\u5df2\u5728 config.yaml \u4e2d\u914d\u7f6e\u4ee4\u724c\u3002\u66f4\u65b0\u8bf7\u7f16\u8f91 config.yaml \u7684 providers \u6bb5\u843d\u6216\u5728\u7ec8\u7aef\u8fd0\u884c hermes auth\u3002',
    providers_oauth_not_configured_hint: '\u5c1a\u672a\u5b8c\u6210\u8ba4\u8bc1\u3002\u8bf7\u5728\u7ec8\u7aef\u8fd0\u884c hermes auth \u4ee5\u914d\u7f6e\u6b64\u63d0\u4f9b\u5546\u3002',
    providers_save: '\u4fdd\u5b58',
    providers_remove: '\u79fb\u9664',
    providers_saving: '\u4fdd\u5b58\u4e2d\u2026',
    ...
    providers_key_show: '\u663e\u793a',
    providers_key_hide: '\u9690\u85cf',
    providers_models_label: '\u6a21\u578b\u5217\u8868',
    providers_models_count: (n) => (n === 1 ? '1 \u4e2a\u6a21\u578b' : `${n} \u4e2a\u6a21\u578b`),
    providers_refresh_models: '\u5237\u65b0\u6a21\u578b\u5217\u8868',
    providers_load_failed: (msg) => `\u52a0\u8f7d\u63d0\u4f9b\u5546\u5931\u8d25\uff1a${msg}`,
    ...
    settings_desc_bot_name: '助手在 UI 中的显示名称。默认为 Cosmius Hermes。',
    settings_desc_password: '输入新密码以设置或更改。留空保持当前设置。',
    // onboarding
    onboarding_badge: '首次运行',
    onboarding_language_label: '语言',
    onboarding_title: '欢迎使用 Cosmius Hermes',
    archive_extracted: (n, c) => `从 ${c} 个压缩包中解压了 ${n} 个文件`,
    onboarding_lead: '快速引导将验证 Cosmius Hermes、保存真实的提供商配置、选择工作区和模型，并可选设置密码保护应用。',
    onboarding_back: '返回',
    onboarding_continue: '继续',
    onboarding_skip: '跳过设置',
    onboarding_skipped: '设置已跳过 — 使用现有配置。',
    onboarding_open: '打开 Cosmius Hermes',
    onboarding_step_system_title: '系统检查',
    onboarding_step_system_desc: '验证 Cosmius Hermes Agent 与配置可见性。',
    onboarding_step_setup_title: '提供商设置',
    onboarding_step_setup_desc: '保存最小可用的 Cosmius Hermes 提供商配置。',
    ...
    onboarding_notice_system_ready: 'Cosmius Hermes Agent 看起来可从 Web UI 访问。',
    onboarding_notice_system_unavailable: 'Cosmius Hermes Agent 尚未完全可用。Bootstrap 可以安装它，但提供商设置可能仍需要终端。',
    onboarding_check_agent: 'Cosmius Hermes Agent',
    ...
    onboarding_notice_setup_required: '请先在此选择一个简单的提供商路径。高级 OAuth 流程暂时仍建议在 Cosmius Hermes CLI 中完成。',
    onboarding_notice_setup_already_ready: '已检测到可用的 Cosmius Hermes 提供商配置。你可以保留它，或在这里替换。',
    onboarding_oauth_provider_ready_title: '提供商已完成认证',
    onboarding_oauth_provider_ready_body: '此实例已配置为使用通过 Cosmius Hermes CLI 设置的 OAuth 提供商（<strong>{provider}</strong>）。这里不需要 API key，点击继续即可完成设置。',
    ...
    onboarding_models_fetching: '正在从提供商拉取可用的聊天模型…',
    onboarding_models_live_failed: '无法刷新在线模型列表，将使用内置目录或手动输入。',
    onboarding_selfcheck_failed_can_skip: '上游接口实际可连通，软件初始化自检异常，可点击跳过配置后在侧边栏手动配置密钥；',
    onboarding_workspace_model_manual_hint: '未获取到在线模型列表，请填写服务端使用的聊天模型 ID。',
    onboarding_workspace_label: '工作区',
    onboarding_workspace_or_path: '或输入工作区路径',
    onboarding_workspace_browse: '浏览…',
    onboarding_workspace_browse_title: '选择工作区目录',
    onboarding_workspace_browse_hint:
      '若未弹出系统文件夹对话框，可在此从服务端列出的目录中选择（仅限主目录、已保存工作区或默认工作区路径下）。',
    onboarding_workspace_browse_up: '上一级',
    onboarding_workspace_browse_use: '使用此文件夹',
    onboarding_workspace_browse_empty: '当前目录下没有子文件夹。',
    onboarding_workspace_browse_load_failed: '无法加载目录列表。',
    onboarding_workspace_browse_loading: '正在加载目录…',
    onboarding_workspace_browse_roots: '起始位置',
    workspace_picker_title: '选择工作区文件夹',
    workspace_picker_hint: '为当前对话选择本机 Windows 文件夹作为工作区。',
    workspace_picker_current_label: '当前工作区',
    workspace_picker_native_title: '从这台电脑选择文件夹',
    workspace_picker_native_hint: '将打开 Windows 文件夹选择窗口。请选择你希望 Cosmius Hermes 使用的工作区文件夹。',
    workspace_picker_native_button: '选择本地文件夹',
    workspace_picker_native_opening: '正在打开 Windows 文件夹选择器...',
    workspace_picker_native_switching: '正在切换工作区...',
    workspace_picker_native_cancelled: '已取消文件夹选择。',
    workspace_picker_native_unavailable: '当前无法使用本地文件夹选择器，请使用下方备用目录浏览。',
    workspace_picker_native_failed: '无法打开文件夹选择器。',
    workspace_picker_fallback_title: '备用服务端目录浏览',
    workspace_picker_saved: '已保存工作区',
    workspace_picker_use: '使用当前文件夹',
    onboarding_workspace_placeholder: '/home/you/workspace',
    ...
    oauth_codex_error: 'OAuth login failed', // TODO: translate
    oauth_codex_expired: 'Code expired, please try again', // TODO: translate
    onboarding_api_key_help_prefix: '会作为密钥保存到 Cosmius Hermes .env 文件中，变量名为',
    onboarding_base_url_label: 'Base URL',
    onboarding_base_url_placeholder: 'https://your-endpoint.example/v1',
    onboarding_base_url_help: '用于 OpenAI 兼容路由、自托管服务、LiteLLM、Ollama、LM Studio、vLLM 或类似端点。',
    onboarding_base_url_preset_label: '常用接口',
    onboarding_deepseek_preset_default: '官方默认（api.deepseek.com）',
    onboarding_deepseek_preset_openai_v1: 'OpenAI 兼容路径（/v1）',
    onboarding_deepseek_base_url_hint:
      'DeepSeek 公共 API 全球同一入口；若客户端或文档要求 OpenAI 兼容格式，可选用带 /v1 的地址，也可在下方手动修改。',
    onboarding_model_label: '默认模型',
    onboarding_workspace_help: '选择设置完成后 Cosmius Hermes 在新聊天中使用的模型。',
    onboarding_custom_model_placeholder: 'your-model-name',
    ...
    // Session list overflow menu + batch actions (简体中文)
    session_archive: '归档对话',
    session_archive_desc: '隐藏此对话；开启「显示已归档」后可查看',
    session_archive_failed: '归档失败：',
    session_archived: '已归档',
    session_delete: '删除对话',
    session_delete_desc: '永久删除此对话',
    session_duplicate: '复制对话',
    session_duplicate_desc: '创建副本（相同工作区与模型）',
    session_duplicate_failed: '复制失败：',
    session_duplicated: '已复制对话',
    session_move_project: '移动到项目',
    session_move_project_desc_has: '更改此对话所属项目',
    session_move_project_desc_none: '为此对话指定项目',
    session_pin: '置顶对话',
    session_pin_desc: '将此对话固定在列表顶部',
    session_pin_failed: '置顶失败：',
    session_restore: '恢复对话',
    session_restore_desc: '将此对话移回主列表',
    session_restored: '已恢复',
    session_unpin: '取消置顶',
    session_unpin_desc: '从置顶区移除',
    session_select_mode: '选择',
    session_select_mode_desc: '多选对话以批量操作',
    ...
    settings_dropdown_providers: '模型提供商',
    settings_dropdown_system: '系统',
    settings_heading_subtitle: '偏好设置、对话工具与系统控制。',
    settings_heading_title: '控制中心',
    settings_section_conversation_title: '对话',
    settings_section_appearance_title: '外观',
    settings_section_appearance_meta: '主题、强调色与视觉样式。',
    settings_section_preferences_title: '偏好设置',
    settings_section_preferences_meta: 'Cosmius Hermes 的默认值与界面行为。',
    settings_section_system_title: '系统',
    settings_section_system_meta: '实例版本与访问控制。',
    ...
    status_profile: '配置档',
    status_hermes_home: 'Cosmius Hermes 目录',
    status_started: '开始时间',
    status_tokens: 'Token',
    status_unknown: '未知',
    cmd_yolo: 'YOLO 模式切换',
    ...
    cmd_branch: '将本对话分叉为新会话',
    cmd_branch_usage: '/branch [名称] — 分叉会话（名称可选）',
    branch_forked: '已分叉到新会话',
    branch_failed: '分叉失败：',
    ...
    checkpoint_date: '日期',
    checkpoint_diff_files_changed: (n) => `已更改 ${n} 个文件`,
    checkpoint_diff_no_changes: '当前工作区与此检查点之间没有差异。',
    checkpoint_diff_title: '检查点中的更改',
    checkpoint_empty: '此工作区暂无检查点。',
    checkpoint_error: '检查点加载失败',
    checkpoint_files: '文件',
    checkpoint_loading: '正在加载检查点…',
    checkpoint_message: '消息',
    checkpoint_restore: '恢复',
    checkpoint_restore_confirm_message: (ckpt) => `将工作区恢复到检查点「${ckpt}」吗？这将用已保存版本覆盖文件。此检查点之后新增的文件不会被删除。`,
    checkpoint_restore_confirm_title: '恢复检查点？',
    checkpoint_restored: '检查点已恢复',
    checkpoint_title: '检查点',
    checkpoint_view_diff: '查看差异',
    insights_activity_by_day: '按日活跃度',
    insights_activity_by_hour: '按小时活跃度',
    insights_cost: '预估费用',
    ...
    insights_title: '使用分析',
    insights_token_breakdown: 'Token 用量分解',
    insights_tokens: 'Token',
    insights_total: '合计',
    settings_desc_api_redact: '自建实例可关闭以完全透明（不推荐在共享环境中关闭）。',
    settings_label_api_redact: '在 API 响应中屏蔽敏感数据',
    voice_error: '此浏览器不支持语音输入',
    ...
    session_exit_select_mode: '退出多选',
    session_projects_all: '全部',
    project_btn_new_title: '新建项目',
    sessions_other_profiles_link: (n) => `显示其他配置档的 ${n} 个会话`,
    sessions_active_profile_only_link: '仅显示当前配置档',
    sessions_archived_hide: '隐藏已归档',
    sessions_archived_show: (n) => `显示 ${n} 个已归档`,
    sessions_empty_in_project: '此项目下还没有会话。',
    session_group_pinned: '\u2605 已置顶',
    session_title_system_placeholder: '会话',
    session_actions_aria: '会话操作',
    session_delete_confirm_short: '确定删除此对话？',
    conversation_deleted_toast: '对话已删除',
    topbar_subtitle_new_chat: '开始新对话',
    session_switch_wait_turn: '请先等待当前回合结束再切换会话。',
    project_picker_none: '无项目',
    session_toast_removed_from_project: '已从项目移除',
    session_toast_moved_to_project: (name) => `已移动到「${name}」`,
    session_toast_archive_failed: '归档失败：',
    session_toast_delete_failed: '删除失败：',
    session_toast_move_failed: '移动失败：',
    session_duplicate_title_suffix: '（副本）',
    session_source_weixin: '微信',
    gateway_sync_unavailable: '网关同步不可用，已改为定时刷新。',
    queued_messages_restored_multi: (n) => `已恢复 ${n} 条排队消息（仅显示第一条）`,
    queued_message_restored: '已恢复排队消息',
    queued_review_send_hint: ' — 请检查后手动发送',
    session_rename_failed_prefix: '重命名失败：',
    project_name_placeholder_short: '项目名称',
    tag_filter_by_title: (tag) => `点击筛选：${tag}`,
    project_picker_create_new: '+ 新建项目',
    project_created_and_moved: (name) => `已创建「${name}」并移动会话`,
    project_created_toast: '项目已创建',
    project_renamed_toast: '项目已重命名',
    project_color_updated: '颜色已更新',
    project_delete_confirm_message: (name) =>
      `删除项目「${name}」？其中的会话将解除关联，不会被删除。`,
    project_deleted_toast: '项目已删除',
    session_delete_failed_status: (msg) => `删除失败：${msg}`,
  },
  ...
  folder_add_as_space_title: '\u65b0\u589e\u70ba\u5de5\u4f5c\u5340\uff1f',
    ...
    settings_section_preferences_meta: 'Cosmius Hermes 的預設值與介面行為。',
    ...
    tab_insights: '統計',
    tab_platforms: '\u804a\u5929\u5e73\u53f0',
    platforms_main_sidebar_hint: '\u5728\u5074\u908a\u6b04\u6e05\u55ae\u9078\u64c7\u5e73\u53f0\uff1b\u8a2d\u5b9a\u62bd\u5c5c\u6703\u84cb\u5728\u6e05\u55ae\u4e0a\uff0c\u5b8c\u6210\u5f8c\u8acb\u5132\u5b58\u3002',
    connect_app_title: '\u9023\u63a5\u61c9\u7528',
    connect_app_subtitle: '\u8a2d\u5b9a\u4e26\u555f\u7528\u8a0a\u606f\u5e73\u53f0\u6574\u5408\u3002',
    connect_app_search_placeholder: '\u641c\u5c0b\u5e73\u53f0\u2026',
    connect_app_filter_all: '\u5168\u90e8',
    connect_app_group_top_picks: '\u512a\u5148\u63a8\u85a6',
    connect_app_group_international_im: '\u570b\u969b\u5373\u6642\u901a\u8a0a',
    connect_app_group_china_workplace_wechat: '\u570b\u5167\u8fa6\u516c\u8207\u5fae\u4fe1\u751f\u614b',
    connect_app_group_open_interfaces: '\u958b\u653e\u4ecb\u9762',
    connect_app_group_traditional_channels: '\u50b3\u7d71\u901a\u9053',
    connect_app_group_others: '\u5176\u5b83',
    connect_app_status_not_configured: '\u672a\u914d\u7f6e',
    connect_app_status_configured: '\u5df2\u914d\u7f6e\uff08\u672a\u9023\u7dda\uff09',
    connect_app_status_connected: '\u5df2\u9023\u7dda',
    connect_app_status_error: '\u9023\u7dda\u7570\u5e38',
    connect_app_configure: '\u914d\u7f6e',
    connect_app_save_enable: '\u5132\u5b58\u4e26\u555f\u7528',
    connect_app_test_connection: '\u6e2c\u8a66\u9023\u7dda',
    connect_app_disable: '\u505c\u7528',
    connect_app_required: '\u5fc5\u586b',
    connect_app_optional: '\u53ef\u9078',
    connect_app_advanced: '\u9032\u968e',
    connect_app_saved_enabled: '\u5132\u5b58\u6210\u529f\uff0c\u5df2\u555f\u7528\u3002',
    connect_app_test_success: '\u9023\u7dda\u6e2c\u8a66\u6210\u529f\u3002',
    connect_app_test_failed_kept: '\u9023\u7dda\u6e2c\u8a66\u5931\u6557\uff0c\u4f46\u914d\u7f6e\u5df2\u4fdd\u7559\u3002',
    connect_app_disabled: '\u5df2\u505c\u7528\u3002',
    connect_app_weixin_qr_intro:
      '\u500b\u4eba\u5fae\u4fe1\u4f7f\u7529\u9a30\u8a0a iLink\uff1a\u7522\u751f\u4e8c\u7dad\u78bc\u5f8c\u7528\u5fae\u4fe1\u6383\u63cf\uff0c\u78ba\u8a8d\u5f8c\u9ede\u300c\u5132\u5b58\u4e26\u555f\u7528\u300d\u5beb\u5165\u914d\u7f6e\u3002',
    connect_app_weixin_get_qr: '\u53d6\u5f97\u4e8c\u7dad\u78bc',
    connect_app_weixin_open_link: '\u5728\u700f\u89bd\u5668\u958b\u555f\u6383\u78bc\u9023\u7d50',
    connect_app_weixin_requesting: '\u6b63\u5728\u8acb\u6c42\u4e8c\u7dad\u78bc\u2026',
    connect_app_weixin_status_wait: '\u7b49\u5f85\u6383\u78bc\u2026',
    connect_app_weixin_status_scaned: '\u5df2\u6383\u78bc\uff0c\u8acb\u5728\u624b\u6a5f\u5fae\u4fe1\u4e2d\u78ba\u8a8d\u2026',
    connect_app_weixin_status_redirect: '\u6b63\u5728\u5207\u63db\u767b\u5165\u5340\u57df\u2026',
    connect_app_weixin_status_expired: '\u4e8c\u7dad\u78bc\u5df2\u904e\u671f\uff0c\u8acb\u91cd\u65b0\u53d6\u5f97\u3002',
    connect_app_weixin_status_confirmed: '\u767b\u5165\u5df2\u78ba\u8a8d\uff0c\u8acb\u9ede\u300c\u5132\u5b58\u4e26\u555f\u7528\u300d\u5beb\u5165\u914d\u7f6e\u3002',
    connect_app_weixin_ready_save: '\u5fae\u4fe1\u767b\u5165\u6210\u529f\uff0c\u8acb\u9ede\u300c\u5132\u5b58\u4e26\u555f\u7528\u300d\u5b8c\u6210\u914d\u7f6e\u3002',
    connect_app_gateway_start_needed: '\u5df2\u5132\u5b58\u3002\u8acb\u555f\u52d5\u6216\u9023\u63a5\u804a\u5929\u7db2\u95dc\u5f8c\u751f\u6548\u3002',
    platforms_panel_intro:
      'Cosmius Hermes \u7db2\u95dc\uff08hermes-agent\uff09\u53ef\u9023\u63a5 Telegram\u3001Discord\u3001\u98db\u66f8\u3001\u4f01\u5fae\u3001Slack \u7b49\uff0c\u4e26\u652f\u63f4 OpenAI \u76f8\u5bb9 HTTP\uff08api_server\uff09\u8207\u81ea\u8a02 webhook\u3002\u65bc\u76ee\u524d\u914d\u7f6e\u6a94\u7684 config.yaml \u8a2d\u5b9a platforms.<\u540d\u7a31>\u3002',
    platforms_yaml_block: 'config.yaml \u952e',
    platforms_adapter_source: '\u9069\u914d\u5668\u6e90\u78bc\uff08\u5009\u5eab\uff09',
    platforms_endpoints: '\u672c\u6a5f HTTP \u4f4d\u5740',
    platforms_copy_url: '\u8907\u88fd\u9023\u7d50',
    platforms_copied: '\u5df2\u8907\u88fd',
    platforms_ready: '\u5df2\u914d\u7f6e',
    platforms_incomplete: '\u672a\u5b8c\u6210',
    platforms_off: '\u672a\u555f\u7528',
    platforms_empty: '\u6b64\u914d\u7f6e\u6a94\u672a\u5b9a\u7fa9\u5e73\u53f0\u3002',
    platforms_load_error: '\u7121\u6cd5\u8b80\u53d6\u7db2\u95dc\u8a2d\u5b9a\u3002',
    platforms_agent_note:
      '\u6191\u8b49\u7559\u5728 config.yaml \u6216\u74b0\u5883\u8b8a\u6578\uff0c\u6b64\u9801\u4e0d\u6703\u986f\u793a Token\u3002\u4fee\u6539\u5f8c\u8acb\u91cd\u555f hermes-agent \u7db2\u95dc\u9032\u7a0b\u3002',
    platforms_form_title: '\u7de8\u8f2f\u8a2d\u5b9a',
    platforms_save: '\u5132\u5b58\u5230 config.yaml',
    platforms_saved: '\u5df2\u5132\u5b58\u3002\u8acb\u91cd\u555f hermes-agent \u7db2\u95dc\u4ee5\u751f\u6548\u3002',
    platforms_save_failed: '\u5132\u5b58\u5931\u6557',
    platforms_secret_placeholder: '\u7559\u7a7a\u5247\u4fdd\u7559\u73fe\u6709\u503c',
    platforms_secret_set_hint: 'config.yaml \u5167\u5df2\u6709\u6b64\u6b04\u4f4d\u7684\u503c\u3002',
    platforms_json_hint:
      '\u5408\u6cd5 JSON \u7269\u4ef6\u3002\u654f\u611f\u503c\u986f\u793a\u70ba\u5713\u9ede\u884c\u2014\u2014\u82e5\u4e0d\u8981\u66f4\u6539\u8acb\u4fdd\u7559\u9019\u4e9b\u5217\u3002',
    platforms_field_enabled: '\u555f\u7528',
    platforms_field_token: 'Bot Token',
    platforms_field_api_key: 'API Key',
    platforms_field_reply_to_mode: '\u56de\u8986\u4e32\u806f',
    platforms_field_extra_json: 'Extra\uff08JSON\uff09',
    platforms_field_app_id: 'App ID',
    platforms_field_app_secret: 'App Secret',
    platforms_field_encrypt_key: '\u52a0\u5bc6 Key',
    platforms_field_verification_token: '\u6821\u9a57 Token',
    platforms_field_account_id: '\u5e33\u865f ID',
    platforms_field_bot_id: 'Bot ID',
    platforms_field_secret: 'Secret',
    platforms_field_websocket_url: 'WebSocket \u4f4d\u5740',
    platforms_field_client_id: 'Client ID',
    platforms_field_client_secret: 'Client Secret',
    platforms_field_robot_code: 'Robot Code',
    platforms_field_host: '\u76e3\u807d\u4f4d\u5740',
    platforms_field_port: '\u902f\u57e0',
    platforms_field_model_name: '\u6a21\u578b\u540d\u7a31',
    platforms_field_routes_json: 'Webhook \u8def\u7531\uff08JSON\uff09',
    platforms_field_http_url: 'Signal HTTP URL',
    platforms_field_extra_url: 'Mattermost \u57fa\u790e URL',
    platforms_field_homeserver: 'Homeserver URL',
    platforms_field_user_id: 'Matrix \u4f7f\u7528\u8005 ID',
    platforms_field_password: 'Matrix \u5bc6\u78bc',
    platforms_weixin_web_intro:
      '\u500b\u4eba\u5fae\u4fe1\u4f7f\u7528\u9a30\u8a0a iLink\uff1a\u5728\u6b64\u9801\u9762\u7528\u5fae\u4fe1\u6383\u63cf\u4e8c\u7dad\u78bc\u5373\u53ef\uff08\u7121\u9700\u7d42\u7aef\uff09\u3002\u78ba\u8a8d\u5f8c\u9ede\u300c\u5132\u5b58\u4e26\u555f\u7528\u300d\u5beb\u5165\u8a2d\u5b9a\u4e26\u5617\u8a66\u91cd\u8f09\u7db2\u95dc\u3002',
    platforms_weixin_bind_btn: '\u5fae\u4fe1\u6383\u78bc\u7d81\u5b9a',
    platforms_weixin_bind_hint:
      '\u6383\u78bc\u6210\u529f\u5f8c\u6703\u81ea\u52d5\u586b\u5165\u5e33\u865f ID \u8207 bot token\uff1b\u4ecd\u53ef\u5728\u4e0b\u65b9\u8abf\u6574\u9032\u968e URL\u3002',
    platforms_weixin_modal_title: '\u5fae\u4fe1 \u2014 \u6383\u78bc\u7d81\u5b9a',
    platforms_weixin_qr_loading: '\u6b63\u5728\u53d6\u5f97\u4e8c\u7dad\u78bc\u2026',
    platforms_weixin_scan_wait: '\u8acb\u7528\u5fae\u4fe1\u6383\u63cf\u4e0b\u65b9\u4e8c\u7dad\u78bc\u3002',
    platforms_weixin_scanned: '\u5df2\u6383\u78bc\uff0c\u8acb\u5728\u624b\u6a5f\u4e0a\u78ba\u8a8d\u3002',
    platforms_weixin_qr_refreshed: '\u4e8c\u7dad\u78bc\u5df2\u5237\u65b0\uff0c\u8acb\u91cd\u65b0\u6383\u63cf\u3002',
    platforms_weixin_confirmed: '\u5df2\u5728\u5fae\u4fe1\u78ba\u8a8d\u7d81\u5b9a\u3002\u9ede\u64ca\u4e0b\u65b9\u6309\u9215\u5132\u5b58\u4e26\u555f\u7528\u3002',
    platforms_weixin_open_link: '\u82e5\u672a\u986f\u793a\u5716\u7247\uff0c\u8acb\u5728\u5df2\u5b89\u88dd\u5fae\u4fe1\u7684\u88dd\u7f6e\u4e0a\u958b\u555f\u6b64\u9023\u7d50\u3002',
    platforms_weixin_apply_btn: '\u5132\u5b58\u4e26\u555f\u7528',
    platforms_weixin_saved: '\u5fae\u4fe1\u8a2d\u5b9a\u5df2\u5132\u5b58\u3002',
    platforms_weixin_saved_restart_ok: '\u5df2\u5132\u5b58\uff0c\u5df2\u5411\u7db2\u95dc\u767c\u8d77\u91cd\u8f09\u8acb\u6c42\u3002',
    platforms_saved_restart_ok: '\u5df2\u5132\u5b58\u3002\u5df2\u5411\u7db2\u95dc\u767c\u8d77\u91cd\u8f09\u8acb\u6c42\uff08SIGUSR1\uff09\u3002',
    platforms_field_weixin_account_id: 'iLink \u5e33\u865f ID\uff08\u6383\u78bc\u767b\u5165\u5f8c\uff09',
    platforms_field_weixin_token: 'iLink bot token\uff08\u53ef\u9078\uff09',
    platforms_field_weixin_token_hint:
      '\u7559\u7a7a\u5247\u4fdd\u7559 config.yaml \u5167\u8a72\u6b04\u4f4d\u73fe\u6709\u503c\u3002\u6383\u78bc\u7d81\u5b9a\u6d41\u7a0b\u6703\u81ea\u52d5\u5beb\u5165 token\u3002',
    platforms_field_weixin_base_url: 'iLink API \u57fa\u790e URL',
    platforms_field_weixin_base_url_hint: '\u7559\u7a7a\u5247\u7528\u9810\u8a2d\uff08ilinkai.weixin.qq.com \u6216\u767b\u5165\u8fd4\u56de\u7684\u4f4d\u5740\uff09\u3002',
    platforms_field_weixin_cdn_base_url: '\u5fae\u4fe1 CDN \u57fa\u790e URL',
    platforms_field_weixin_cdn_base_url_hint:
      '\u9810\u8a2d\u901a\u5e38\u70ba https://novac2c.cdn.weixin.qq.com/c2c \u2014\u2014 \u50c5\u5728 iLink \u8fd4\u56de\u5176\u4ed6\u503c\u6642\u518d\u6539\u3002',
    tab_workspaces: '\u5de5\u4f5c\u5340',
    ...
    settings_desc_bot_name: '助手在 UI 中的顯示名稱。預設為 Cosmius Hermes。',
    ...
    tab_settings: '\u8a2d\u5b9a',
    titlebar_view_version: '\u67e5\u770b\u7248\u672c',
    titlebar_view_version_hint: '\u67e5\u770b Cosmius Hermes Agent \u7248\u672c\u8207\u93e1\u50cf\u72c0\u614b',
    gateway_status_title: '\u7db2\u95dc',
    gateway_status_running: '\u5df2\u9023\u7dda',
    gateway_status_stopped: '\u672a\u904b\u884c',
    gateway_status_checking: '\u6aa2\u6e2c\u4e2d\u2026',
    gateway_status_error: '\u72c0\u614b\u7121\u6cd5\u53d6\u5f97',
    gateway_reload_btn: '\u91cd\u8f09',
    gateway_reload_ok: '\u5df2\u5411\u7db2\u95dc\u767c\u9001\u91cd\u8f09\u8a0a\u865f\uff08SIGUSR1\uff09\u3002',
    gateway_reload_fail: '\u7121\u6cd5\u5b8c\u6210\u91cd\u8f09\u3002',
    gateway_reload_not_running: '\u672a\u767c\u73fe\u7db2\u95dc\u9032\u7a0b\u3002\u8acb\u5728\u672c\u6a5f\u555f\u52d5\u804a\u5929\u7db2\u95dc\uff08\u5982 hermes gateway\uff09\u5f8c\u518d\u8a66\u3002',
    gateway_start_ok: '\u5df2\u5728\u5f8c\u53f0\u70ba\u6b64\u914d\u7f6e\u555f\u52d5\u7db2\u95dc\u3002',
    gateway_start_pending: '\u5df2\u8acb\u6c42\u555f\u52d5\u7db2\u95dc\uff0c\u6b63\u7b49\u5f85\u9032\u7a0b\u8a3b\u518a\uff08\u72c0\u614b\u5c07\u81ea\u52d5\u5237\u65b0\uff09\u3002',
    gateway_start_failed: '\u7121\u6cd5\u5f9e\u754c\u9762\u555f\u52d5\u7db2\u95dc\u3002\u8acb\u67e5\u770b\u4e0b\u65b9\u65e5\u8a8c\u8def\u5f91\u6216\u5728\u7d42\u7aef\u57f7\u884c hermes gateway\u3002',
    gateway_reload_sigusr: '\u76ee\u524d\u7cfb\u7d71\u4e0d\u652f\u63f4 SIGUSR1 \u512a\u96c5\u91cd\u8f09\uff0c\u8acb\u5b8c\u5168\u91cd\u555f\u7db2\u95dc\u9032\u7a0b\u3002',
    titlebar_about_us: '\u95dc\u65bc\u6211\u5011',
    titlebar_about_hint: '\u958b\u6e90\u7d44\u4ef6\u7c21\u4ecb',
    titlebar_business_coop: '\u5546\u52d9\u5408\u4f5c',
    titlebar_business_coop_hint: '\u5546\u52d9\u8207\u5171\u5275\u5782\u8a62',
    titlebar_skill_market: '\u6a21\u578b\u5ee3\u5834',
    titlebar_skill_market_hint: '\u6253\u958bKyvolen Token\u5e73\u53f0',
    titlebar_github_hint: '',
    business_modal_title: '\u5546\u52d9\u5408\u4f5c',
    business_modal_mission:
      '\u6211\u5011\u81f4\u529b\u65bc\u63a8\u52d5\u4eba\u5de5\u667a\u6167\u7684\u666e\u60e0\u5316\uff0c\u8b93\u500b\u4eba\u8207\u7d44\u7e54\u90fd\u80fd\u4ee5\u66f4\u4f4e\u9580\u6abb\u3001\u66f4\u9806\u66a2\u7684\u65b9\u5f0f\u4f7f\u7528 AI\uff0c\u800c\u4e0d\u662f\u9577\u671f\u53d7\u9650\u65bc\u74b0\u5883\u5efa\u7f6e\u3001\u90e8\u7f72\u8207\u7dad\u904b\u7b49\u74b0\u7bc0\uff1b\u4f7f\u667a\u6167\u6280\u8853\u771f\u6b63\u670d\u52d9\u65bc\u975e\u6280\u8853\u80cc\u666f\u7684\u65e5\u5e38\u5de5\u4f5c\u8207\u5b78\u7fd2\u60c5\u5883\u3002',
    business_modal_cta:
      '\u82e5\u60a8\u6216\u60a8\u7684\u6a5f\u69cb\u8207\u6211\u5011\u6709\u76f8\u540c\u9858\u666f\uff0c\u6b61\u8fce\u900f\u904e\u98db\u66f8\u8207\u6211\u5011\u806f\u7e6b\u3001\u5171\u63a2\u5408\u4f5c\u3002\u65b0\u589e\u6216\u7559\u8a00\u6642\u8acb\u5099\u8a3b\u300c\u5546\u52d9\u5408\u4f5c\u300d\uff0c\u4ee5\u4fbf\u6211\u5011\u76e1\u5feb\u8207\u60a8\u5c0d\u63a5\u3002',
    business_modal_email_label: '\u806f\u7d61\u4fe1\u7bb1\uff1a',
    about_modal_title: '\u95dc\u65bc\u6211\u5011',
    about_brand_name: 'Cosmius Hermes',
    about_channel_douyin: 'Cosmius Hermes',
    about_channel_feishu: 'Cosmius Hermes',
    about_community_blurb:
      'Cosmius Hermes \u5c07\u672c\u5730 Agent\u3001Web UI\u3001Windows \u555f\u52d5\u5668\u3001\u57f7\u884c\u6642\u8207\u5be6\u7528\u6280\u80fd\u6574\u5408\u70ba\u4e00\u500b\u4e7e\u6de8\u7684\u684c\u9762\u9ad4\u9a57\uff0c\u670d\u52d9\u65e5\u5e38 AI \u5de5\u4f5c\u6d41\u3002',
    about_agent_heading: 'Cosmius Hermes Agent',
    about_agent_blurb:
      '\u7531 Cosmius Hermes \u7dad\u8b77\u7684\u958b\u6e90 AI Agent \u57f7\u884c\u6642\u74b0\uff0c\u70ba\u672c\u4ecb\u9762\u63d0\u4f9b\u5c0d\u8a71\u3001\u5de5\u5177\u3001\u6280\u80fd\u3001\u6392\u7a0b\u8207\u7db2\u95dc\u7b49\u80fd\u529b\u3002',
    about_agent_copyright: 'Copyright (c) 2025 Cosmius Hermes',
    about_webui_heading: 'Cosmius Hermes Web UI',
    about_webui_blurb:
      'Cosmius Hermes 的浏览器界面，本应用在本地组合 Web UI 与 Agent 以便使用。',
    about_webui_copyright: 'Copyright (c) 2025 Cosmius Hermes Contributors',
    agent_version_loading: '\u8f09\u5165\u4e2d\u2026',
    agent_version_modal_title: 'Cosmius Hermes Agent \u7248\u672c',
    agent_version_branch: '\u93e1\u50cf\u5206\u652f',
    agent_version_path: 'Agent \u8def\u5f91',
    agent_version_mirror_url_label: '\u93e1\u50cf\u4f4d\u5740',
    agent_version_mirror_fallback_note: '\u4e3b\u93e1\u50cf\u7121\u6cd5\u9023\u7dda\uff0c\u5df2\u6539\u7528\u5099\u7528\u93e1\u50cf\uff1a',
    agent_version_local_label: '\u672c\u5730\u7248\u672c',
    agent_version_release_label: '\u767c\u884c\u7248\u672c',
    agent_version_git_label: 'Git \u63cf\u8ff0',
    agent_version_mirror_label: '\u93e1\u50cf\u6700\u65b0\u63d0\u4ea4',
    agent_version_behind: '\u843d\u5f8c\u93e1\u50cf {n} \u500b\u63d0\u4ea4',
    agent_version_maybe_behind: '\u93e1\u50cf\u8207\u672c\u5730\u63d0\u4ea4\u4e0d\u4e00\u81f4\uff08\u7121\u6cd5\u7cbe\u78ba\u8a08\u6578\uff09\u3002',
    agent_version_synced: '\u5df2\u8207\u93e1\u50cf\u540c\u6b65\u3002',
    agent_version_no_agent: '\u672a\u5728\u6b64\u4f3a\u670d\u5668\u627e\u5230 Agent \u76ee\u9304\u3002',
    agent_version_no_git: '\u76ee\u524d\u76ee\u9304\u4e0d\u662f Git \u5009\u5eab\uff0c\u50c5\u986f\u793a\u672c\u5730\u6a19\u7c64\u3002',
    agent_version_error: '\u7121\u6cd5\u8b80\u53d6\u72c0\u614b\uff1a{msg}',
    agent_version_refresh: '\u91cd\u65b0\u6574\u7406',
    agent_version_update_btn: '\u900f\u904e\u570b\u5167\u93e1\u50cf\u66f4\u65b0',
    agent_version_update_confirm_title: '\u900f\u904e\u93e1\u50cf\u66f4\u65b0 Agent\uff1f',
    agent_version_update_confirm_message: '\u5c07\u5f9e\u570b\u5167 Git \u93e1\u50cf\u62c9\u53d6\u6700\u65b0\u63d0\u4ea4\uff1b\u5b8c\u6210\u5f8c Web \u670d\u52d9\u6703\u91cd\u555f\u3002',
    agent_version_update_started: '\u6b63\u5728\u5f9e\u93e1\u50cf\u66f4\u65b0\u4e26\u91cd\u555f\u2026',
    agent_version_update_failed: '\u66f4\u65b0\u5931\u6557\u3002',
    agent_toast_new_version: '\u93e1\u50cf\u4e0a\u6709\u65b0\u7684 hermes-agent \u7248\u672c\uff0c\u8acb\u9ede\u64ca\u300c\u67e5\u770b\u7248\u672c\u300d\u66f4\u65b0\u3002',
    ...
    n_messages: (n) => `${n} 則訊息`,
    load_older_messages: '↑ 向上捲動或點擊以載入較早的訊息',
    onboarding_api_key_help_prefix: '\u900f\u904e\u4ee5\u4e0b\u65b9\u5f0f\u5132\u5b58\u70ba Cosmius Hermes .env \u6a94\u6848\u4e2d\u7684\u6a5f\u5bc6',
    ...
    onboarding_lead: '\u5feb\u901f\u9010\u6b65\u8a2d\u5b9a\uff1a\u6aa2\u67e5 Cosmius Hermes\u3001\u5132\u5b58\u63d0\u4f9b\u8005\u914d\u7f6e\u3001\u9078\u64c7\u5de5\u4f5c\u5340\u8207\u6a21\u578b\uff0c\u4e26\u53ef\u9078\u64c7\u52a0\u5165\u5bc6\u78bc\u4fdd\u8b77\u3002',
    ...
    onboarding_notice_setup_already_ready: '\u5df2\u5075\u6e2c\u5230\u53ef\u7528\u7684 Cosmius Hermes \u63d0\u4f9b\u8005\u914d\u7f6e\u3002\u60a8\u53ef\u4ee5\u4fdd\u7559\u6216\u5728\u6b64\u53d6\u4ee3\u3002',
    onboarding_notice_setup_required: '\u5728\u6b64\u9078\u64c7\u5feb\u901f\u63d0\u4f9b\u8005\u8a2d\u5b9a\u8def\u5f91\u3002\u9032\u968e OAuth \u8a2d\u5b9a\u4ecd\u8acb\u4f7f\u7528 Cosmius Hermes CLI\u3002',
    onboarding_notice_system_ready: 'Cosmius Hermes Agent \u53ef\u5f9e Web UI \u5b58\u53d6\u3002',
    onboarding_notice_system_unavailable: 'Cosmius Hermes Agent \u5c1a\u672a\u5b8c\u5168\u53ef\u7528\u3002\u5f15\u5c0e\u7a0b\u5f0f\u53ef\u80fd\u5b89\u88dd\u5b83\uff0c\u4f46\u63d0\u4f9b\u8005\u8a2d\u5b9a\u53ef\u80fd\u4ecd\u9700\u7d42\u7aef\u6a5f\u3002',
    ...
    onboarding_oauth_provider_ready_body: '\u6b64\u5be6\u4f8b\u8a2d\u5b9a\u4f7f\u7528\u900f\u904e Cosmius Hermes CLI \u914d\u7f6e\u7684 OAuth \u63d0\u4f9b\u8005\uff08<strong>{provider}</strong>\uff09\u3002\u7121\u9700 API \u91d1\u9470 \u2014 \u6309\u7e7c\u7e8c\u5b8c\u6210\u8a2d\u5b9a\u3002',
    onboarding_oauth_provider_ready_title: '\u63d0\u4f9b\u8005\u5df2\u6388\u6b0a',
    onboarding_oauth_switch_hint: '\u6216\u9078\u64c7\u4e0b\u65b9\u5176\u4ed6\u63d0\u4f9b\u8005\u4ee5\u5207\u63db\u5230 API \u91d1\u9470\u8a2d\u5b9a\uff1a',
    onboarding_open: '\u958b\u555f Cosmius Hermes',
    ...
    onboarding_step_setup_desc: '\u5132\u5b58\u6700\u5c0f\u53ef\u7528\u7684 Cosmius Hermes \u63d0\u4f9b\u8005\u914d\u7f6e\u3002',
    onboarding_step_setup_title: '\u63d0\u4f9b\u8005\u8a2d\u5b9a',
    onboarding_step_system_desc: '\u9a57\u8b49 Cosmius Hermes Agent \u8207\u914d\u7f6e\u53ef\u898b\u6027\u3002',
    onboarding_step_system_title: '\u7cfb\u7d71\u6aa2\u67e5',
    onboarding_step_workspace_desc: '\u70ba\u65b0\u6703\u8a71\u9078\u64c7\u9810\u8a2d\u503c\u3002',
    onboarding_step_workspace_title: '\u5de5\u4f5c\u5340\u8207\u6a21\u578b',
    onboarding_language_label: '\u8a9e\u8a00',
    onboarding_title: '\u6b61\u8fce\u4f7f\u7528 Cosmius Hermes',
    onboarding_unknown: '\u672a\u77e5',
    onboarding_workspace_help: '\u9078\u64c7 Cosmius Hermes \u5728\u8a2d\u5b9a\u5b8c\u6210\u5f8c\u7528\u65bc\u65b0\u804a\u5929\u5ba4\u7684\u6a21\u578b\u3002',
    ...
    providers_key_show: '\u986f\u793a',
    providers_key_hide: '\u96b1\u85cf',
    providers_models_label: '\u6a21\u578b\u6e05\u55ae',
    providers_models_count: (n) => (n === 1 ? '1 \u500b\u6a21\u578b' : `${n} \u500b\u6a21\u578b`),
    providers_refresh_models: '\u91cd\u65b0\u6574\u7406\u6a21\u578b',
    providers_load_failed: (msg) => `\u8f09\u5165\u63d0\u4f9b\u8005\u5931\u6557\uff1a${msg}`,
    ...
    status_profile: '個人資料',
    status_hermes_home: 'Cosmius Hermes 主目錄',
    status_started: '開始時間',
    status_tokens: 'Token',
    ...
    checkpoint_diff_no_changes: '目前工作區與此檢查點之間沒有差異。',
    checkpoint_diff_title: '檢查點中的變更',
    checkpoint_empty: '此工作區尚無檢查點。',
    checkpoint_error: '檢查點載入失敗',
    checkpoint_files: '檔案',
    checkpoint_loading: '正在載入檢查點…',
    checkpoint_message: '訊息',
    checkpoint_restore: '還原',
    checkpoint_restore_confirm_message: (ckpt) => `將工作區還原到檢查點「${ckpt}」嗎？這將以已儲存版本覆寫檔案。此檢查點之後新增的檔案不會被刪除。`,
    checkpoint_restore_confirm_title: '還原檢查點？',
    checkpoint_restored: '檢查點已還原',
    checkpoint_title: '檢查點',
    checkpoint_view_diff: '檢視差異',
    insights_activity_by_day: '依日活躍度',
    insights_activity_by_hour: '依小時活躍度',
    insights_cost: '預估費用',
    ...
    insights_peak_hour: '高峰：{hour}',
    insights_sessions: '工作階段',
    insights_title: '使用分析',
    insights_token_breakdown: 'Token 用量分解',
    insights_tokens: 'Token',
    insights_total: '合計',
    settings_desc_api_redact: '自建執行個體可關閉以完全透明（不建議在共用環境中關閉）。',
    settings_label_api_redact: '在 API 回應中遮罩敏感資料',
    voice_error: '此瀏覽器不支援語音輸入',
    ...
    voice_thinking: '正在思考…',
    voice_toggle: '語音輸入',
    subagent_children: '子代理工作階段',
    session_exit_select_mode: '結束多選',
    session_projects_all: '全部',
    project_btn_new_title: '新增專案',
    sessions_other_profiles_link: (n) => `顯示其他設定檔的 ${n} 個會話`,
    sessions_active_profile_only_link: '僅顯示目前設定檔',
    sessions_archived_hide: '隱藏已封存',
    sessions_archived_show: (n) => `顯示 ${n} 個已封存`,
    sessions_empty_in_project: '此專案尚無會話。',
    session_group_pinned: '\u2605 已釘選',
    session_title_system_placeholder: '會話',
    session_actions_aria: '會話操作',
    session_delete_confirm_short: '確定刪除此對話？',
    conversation_deleted_toast: '對話已刪除',
    topbar_subtitle_new_chat: '開始新對話',
    session_switch_wait_turn: '請先等待目前回合結束再切換會話。',
    project_picker_none: '無專案',
    session_toast_removed_from_project: '已從專案移除',
    session_toast_moved_to_project: (name) => `已移至「${name}」`,
    session_toast_archive_failed: '封存失敗：',
    session_toast_delete_failed: '刪除失敗：',
    session_toast_move_failed: '移動失敗：',
    session_duplicate_title_suffix: '（副本）',
    session_source_weixin: '微信',
    gateway_sync_unavailable: '閘道同步不可用，已改為定期重新整理。',
    queued_messages_restored_multi: (n) => `已還原 ${n} 則排隊訊息（僅顯示第一則）`,
    queued_message_restored: '已還原排隊訊息',
    queued_review_send_hint: ' — 請檢查後手動傳送',
    session_rename_failed_prefix: '重新命名失敗：',
    project_name_placeholder_short: '專案名稱',
    tag_filter_by_title: (tag) => `點擊篩選：${tag}`,
    project_picker_create_new: '+ 新增專案',
    project_created_and_moved: (name) => `已建立「${name}」並移動會話`,
    project_created_toast: '專案已建立',
    project_renamed_toast: '專案已重新命名',
    project_color_updated: '顏色已更新',
    project_delete_confirm_message: (name) =>
      `刪除專案「${name}」？其中的會話將解除關聯，不會被刪除。`,
    project_deleted_toast: '專案已刪除',
    session_delete_failed_status: (msg) => `刪除失敗：${msg}`,
  },
  ...
  pt: {
    ...
    cmd_skills: 'Listar skills disponíveis do Cosmius Hermes',
    ...
    status_hermes_home: 'Diretório Cosmius Hermes',
    ...
    settings_section_preferences_meta: 'Padrões e comportamento UI do Cosmius Hermes.',
    ...
    settings_desc_bot_name: 'Nome de exibição do assistente. Padrão: Cosmius Hermes.',
    ...
    onboarding_language_label: 'Idioma',
    onboarding_title: 'Bem-vindo ao Cosmius Hermes',
    onboarding_lead: 'Uma configuração rápida vai verificar Cosmius Hermes, salvar provedor, escolher workspace e modelo, e opcionalmente proteger com senha.',
    ...
    onboarding_step_system_desc: 'Verificar Cosmius Hermes Agent e visibilidade da config.',
    onboarding_step_setup_title: 'Configuração do provedor',
    onboarding_step_setup_desc: 'Salvar config mínima do provedor Cosmius Hermes.',
    ...
    onboarding_notice_system_ready: 'Cosmius Hermes Agent parece acessível pela Web UI.',
    onboarding_notice_system_unavailable: 'Cosmius Hermes Agent não está totalmente disponível. Bootstrap pode instalar, mas setup do provedor pode requerer terminal.',
    onboarding_check_agent: 'Cosmius Hermes Agent',
    ...
    onboarding_notice_setup_required: 'Escolha caminho simples de provedor aqui. OAuth avançado ainda pertence ao Cosmius Hermes CLI.',
    onboarding_notice_setup_already_ready: 'Setup de provedor Cosmius Hermes já detectado. Pode manter ou substituir.',
    ...
    onboarding_api_key_help_prefix: 'Salvo como segredo no .env do Cosmius Hermes usando',
    onboarding_base_url_label: 'Base URL',
    ...
    onboarding_workspace_help: 'Escolha modelo que Cosmius Hermes deve usar para novos chats.',
  ...
  ko: {
    ...
    status_profile: '프로필',
    status_hermes_home: 'Cosmius Hermes 홈',
    ...
    settings_section_preferences_meta: 'Cosmius Hermes의 기본값과 UI 동작.',
    ...
    settings_desc_bot_name: 'UI 전체에 표시되는 Assistant 이름입니다. 기본값은 Cosmius Hermes입니다.',
    ...
    onboarding_language_label: '언어',
    onboarding_title: 'Cosmius Hermes에 오신 것을 환영합니다',
    onboarding_lead: '간단한 안내 설정으로 Cosmius Hermes 설치를 확인하고, 워크스페이스와 모델을 선택하며, 필요하면 비밀번호로 앱을 보호합니다.',
    onboarding_back: '뒤로',
...
// Active locale — Cosmius Hermes defaults to Chinese; loadLocale() refines from storage.
 ...
 * @param {string} lang
 */
function syncTitlebarLocaleToggle() {
  try {
    const en = document.getElementById('titlebarLangEn');
    const zh = document.getElementById('titlebarLangZh');
    if (!en || !zh) return;
    const raw = localStorage.getItem('hermes-lang') || 'zh';
    const onEn = raw === 'en';
    const onZh = raw === 'zh' || raw === 'zh-Hant';
    en.classList.toggle('active', onEn);
    zh.classList.toggle('active', onZh);
    en.setAttribute('aria-pressed', onEn ? 'true' : 'false');
    zh.setAttribute('aria-pressed', onZh ? 'true' : 'false');
  } catch {
    /* ignore */
  }
}
...
/**
 * Title bar quick switch: English ↔ 中文 (simplified). Persists via setLocale.
...
function setLocale(lang) {
  ...
  if (typeof applyLocaleToDOM === 'function') {
    try {
      ...
      /* DOM may not be ready during very early boot */
    }
  }
  syncTitlebarLocaleToggle();
}
...
function applyLocaleToDOM() {
  ...
  if (typeof refreshGatewayTitlebar === 'function') {
    try {
      refreshGatewayTitlebar();
    } catch {
      /* optional titlebar helper */
    }
  }
  syncTitlebarLocaleToggle();
}
